    ...
    101f:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "stressfs starting\n");
    102f:	68 88 18 00 00       	push   $0x1888
    1034:	6a 01                	push   $0x1
  char path[] = "stressfs0";
    ...
    1047:	73 66 73 
  printf(1, "stressfs starting\n");
    104a:	e8 d1 04 00 00       	call   1520 <printf>
  memset(data, 'a', sizeof(data));
  ...
  printf(1, "write %d\n", i);
    1085:	68 9b 18 00 00       	push   $0x189b
    108a:	6a 01                	push   $0x1
    108c:	e8 8f 04 00 00       	call   1520 <printf>
  path[8] += i;
...
//    printf(fd, "%d\n", i);
  ...
  printf(1, "read\n");
    10d8:	58                   	pop    %eax
    10d9:	5a                   	pop    %edx
    10da:	68 a5 18 00 00       	push   $0x18a5
    10df:	6a 01                	push   $0x1
    10e1:	e8 3a 04 00 00       	call   1520 <printf>
    ...
    147c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    14a9:	0f b6 92 b4 18 00 00 	movzbl 0x18b4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    16a4:	eb 1a                	jmp    16c0 <printf+0x1a0>
          s = "(null)";
    16a6:	bb ab 18 00 00       	mov    $0x18ab,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    16f5:	a1 6c 1b 00 00       	mov    0x1b6c,%eax
{
    ...
    1716:	73 10                	jae    1728 <free+0x38>
{
  ...
  freep = p;
    ...
    1741:	5b                   	pop    %ebx
  freep = p;
    1742:	a3 6c 1b 00 00       	mov    %eax,0x1b6c
}
    1747:	5e                   	pop    %esi
    1748:	5f                   	pop    %edi
    1749:	5d                   	pop    %ebp
  ...
  freep = p;
    176a:	a3 6c 1b 00 00       	mov    %eax,0x1b6c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1790:	8b 3d 6c 1b 00 00    	mov    0x1b6c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17d9:	8b 3d 6c 1b 00 00    	mov    0x1b6c,%edi
  ...
  return freep;
    1807:	a1 6c 1b 00 00       	mov    0x1b6c,%eax
    ...
    1834:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1837:	a3 6c 1b 00 00       	mov    %eax,0x1b6c
}
    ...
    base.s.ptr = freep = prevp = &base;
    1850:	c7 05 6c 1b 00 00 70 	movl   $0x1b70,0x1b6c
    1857:	1b 00 00 
    base.s.size = 0;
    185a:	bf 70 1b 00 00       	mov    $0x1b70,%edi
    base.s.ptr = freep = prevp = &base;
    185f:	c7 05 70 1b 00 00 70 	movl   $0x1b70,0x1b70
    1866:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1869:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    186b:	c7 05 74 1b 00 00 00 	movl   $0x0,0x1b74
    1872:	00 00 00 
    if(p->s.size >= nunits){
