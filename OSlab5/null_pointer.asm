...
_null_pointer:     file format elf32-i386
...
int main(int argc, char *argv[])
{
   ...
   int parent_process_id = getpid();
    1015:	e8 39 03 00 00       	call   1353 <getpid>

   if (fork() == 0) 
    101a:	e8 ac 02 00 00       	call   12cb <fork>
    101f:	85 c0                	test   %eax,%eax
    1021:	75 34                	jne    1057 <main+0x57>
   {
    ...
    1023:	52                   	push   %edx
    1024:	52                   	push   %edx
    1025:	68 b8 17 00 00       	push   $0x17b8
    102a:	6a 01                	push   $0x1
    102c:	e8 1f 04 00 00       	call   1450 <printf>
      printf(1, "Null pointer dereference: \n");
    1031:	59                   	pop    %ecx
    1032:	58                   	pop    %eax
    1033:	68 e5 18 00 00       	push   $0x18e5
    1038:	6a 01                	push   $0x1
    103a:	e8 11 04 00 00       	call   1450 <printf>
      printf(1, "null_page: %x\nnull_page_pointer(*null_page):\n", null_page);
    103f:	83 c4 0c             	add    $0xc,%esp
    1042:	6a 00                	push   $0x0
    1044:	68 1c 18 00 00       	push   $0x181c
    1049:	6a 01                	push   $0x1
    104b:	e8 00 04 00 00       	call   1450 <printf>
      printf(1, "%x\n", *null_page);
    1050:	a1 00 00 00 00       	mov    0x0,%eax
    1055:	0f 0b                	ud2    
   ...
   {
      wait();
    1057:	e8 7f 02 00 00       	call   12db <wait>
   }
   ...
   printf(1, "Successfully pass!\nProgram point to page number Zero, since we shift pages, then there is a page fault,\nand since page doesn't exist it cause an error.\n");
    105c:	50                   	push   %eax
    105d:	50                   	push   %eax
    105e:	68 4c 18 00 00       	push   $0x184c
    1063:	6a 01                	push   $0x1
    1065:	e8 e6 03 00 00       	call   1450 <printf>
   exit();
    106a:	e8 64 02 00 00       	call   12d3 <exit>
    106f:	90                   	nop
    ...
    13ac:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13d9:	0f b6 92 08 19 00 00 	movzbl 0x1908(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15d4:	eb 1a                	jmp    15f0 <printf+0x1a0>
          s = "(null)";
    15d6:	bb 01 19 00 00       	mov    $0x1901,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1625:	a1 b0 1b 00 00       	mov    0x1bb0,%eax
{
    ...
    1646:	73 10                	jae    1658 <free+0x38>
{
  ...
  freep = p;
    ...
    1671:	5b                   	pop    %ebx
  freep = p;
    1672:	a3 b0 1b 00 00       	mov    %eax,0x1bb0
}
    1677:	5e                   	pop    %esi
    1678:	5f                   	pop    %edi
    1679:	5d                   	pop    %ebp
  ...
  freep = p;
    169a:	a3 b0 1b 00 00       	mov    %eax,0x1bb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16c0:	8b 3d b0 1b 00 00    	mov    0x1bb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1709:	8b 3d b0 1b 00 00    	mov    0x1bb0,%edi
  ...
  return freep;
    1737:	a1 b0 1b 00 00       	mov    0x1bb0,%eax
    ...
    1764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1767:	a3 b0 1b 00 00       	mov    %eax,0x1bb0
}
    ...
    base.s.ptr = freep = prevp = &base;
    1780:	c7 05 b0 1b 00 00 b4 	movl   $0x1bb4,0x1bb0
    1787:	1b 00 00 
    base.s.size = 0;
    178a:	bf b4 1b 00 00       	mov    $0x1bb4,%edi
    base.s.ptr = freep = prevp = &base;
    178f:	c7 05 b4 1b 00 00 b4 	movl   $0x1bb4,0x1bb4
    1796:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    179b:	c7 05 b8 1b 00 00 00 	movl   $0x0,0x1bb8
    17a2:	00 00 00 
    if(p->s.size >= nunits){
