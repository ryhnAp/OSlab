...
main(int argc, char *argv[])
{
  ...
  exit();
    ...
    1053:	68 dc 17 00 00       	push   $0x17dc
    1058:	6a 02                	push   $0x2
    ...
    13bc:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    ...
    13e9:	0f b6 92 fc 17 00 00 	movzbl 0x17fc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    15e4:	eb 1a                	jmp    1600 <printf+0x1a0>
          s = "(null)";
    15e6:	bb f5 17 00 00       	mov    $0x17f5,%ebx
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1635:	a1 b4 1a 00 00       	mov    0x1ab4,%eax
{
    ...
    1656:	73 10                	jae    1668 <free+0x38>
{
  ...
  freep = p;
    16aa:	a3 b4 1a 00 00       	mov    %eax,0x1ab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    16d0:	8b 3d b4 1a 00 00    	mov    0x1ab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1719:	8b 3d b4 1a 00 00    	mov    0x1ab4,%edi
  ...
  return freep;
    1747:	a1 b4 1a 00 00       	mov    0x1ab4,%eax
    ...
    1797:	1a 00 00 
    base.s.size = 0;
    179a:	bf b8 1a 00 00       	mov    $0x1ab8,%edi
    base.s.ptr = freep = prevp = &base;
    179f:	c7 05 b8 1a 00 00 b8 	movl   $0x1ab8,0x1ab8
    17a6:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    17a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    17ab:	c7 05 bc 1a 00 00 00 	movl   $0x0,0x1abc
    17b2:	00 00 00 
    if(p->s.size >= nunits){
