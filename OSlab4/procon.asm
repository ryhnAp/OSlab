  ...
  12:	31 db                	xor    %ebx,%ebx
{
  ...
  18:	6a 01                	push   $0x1
  1a:	6a 00                	push   $0x0
  1c:	e8 72 04 00 00       	call   493 <sem_init>
  ...
  2e:	83 c3 01             	add    $0x1,%ebx
        sem_init(i, 1); // binary lock
  31:	e8 5d 04 00 00       	call   493 <sem_init>
    for (int i = 0; i <= SIZE+SIZE; i++)
  36:	83 c4 10             	add    $0x10,%esp
  39:	83 fb 0b             	cmp    $0xb,%ebx
  ...
  41:	31 db                	xor    %ebx,%ebx
        sem_acquire(i); // get empty
  43:	6a 05                	push   $0x5
  45:	e8 39 04 00 00       	call   483 <sem_acquire>
  4a:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
  51:	e8 2d 04 00 00       	call   483 <sem_acquire>
  56:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
  5d:	e8 21 04 00 00       	call   483 <sem_acquire>
  62:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  69:	e8 15 04 00 00       	call   483 <sem_acquire>
  6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  75:	e8 09 04 00 00       	call   483 <sem_acquire>
  7a:	83 c4 10             	add    $0x10,%esp
    {        
        int id = fork();
  7d:	e8 19 03 00 00       	call   39b <fork>
        if(!id)
  82:	83 c3 01             	add    $0x1,%ebx
  85:	85 c0                	test   %eax,%eax
  87:	74 0f                	je     98 <main+0x98>
    for(int i = 0 ; i < SIZE ; i++)
  89:	83 fb 05             	cmp    $0x5,%ebx
  8c:	75 ef                	jne    7d <main+0x7d>
            procon(i+1);
    }

    exit();
  8e:	e8 10 03 00 00       	call   3a3 <exit>
  93:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  97:	90                   	nop
            procon(i+1);
  98:	83 ec 0c             	sub    $0xc,%esp
  9b:	53                   	push   %ebx
  9c:	e8 0f 00 00 00       	call   b0 <procon>
  a1:	83 c4 10             	add    $0x10,%esp
  a4:	eb e3                	jmp    89 <main+0x89>
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
  ...
  b8:	be 05 00 00 00       	mov    $0x5,%esi
{
  ...
  c3:	8d 43 06             	lea    0x6(%ebx),%eax
  c6:	50                   	push   %eax
  c7:	e8 b7 03 00 00       	call   483 <sem_acquire>
        sem_acquire(MUTEX);
  cc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d3:	e8 ab 03 00 00       	call   483 <sem_acquire>
        printf(1, "Produce value\n");
  d8:	58                   	pop    %eax
  d9:	5a                   	pop    %edx
  da:	68 c8 08 00 00       	push   $0x8c8
  df:	6a 01                	push   $0x1
  e1:	e8 7a 04 00 00       	call   560 <printf>
        sem_release(MUTEX);
  e6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  ed:	e8 99 03 00 00       	call   48b <sem_release>
        sem_release(SIZE - j);
  ...
  fc:	e8 8a 03 00 00       	call   48b <sem_release>
        sem_release(j+1);
 101:	89 1c 24             	mov    %ebx,(%esp)
 104:	e8 82 03 00 00       	call   48b <sem_release>
        printf(1, "Add to queue.\n");
 109:	59                   	pop    %ecx
 10a:	58                   	pop    %eax
 10b:	68 d7 08 00 00       	push   $0x8d7
 110:	6a 01                	push   $0x1
 112:	e8 49 04 00 00       	call   560 <printf>
    for(int j = 0 ; j < 5 ; j++)
 117:	83 c4 10             	add    $0x10,%esp
 11a:	83 fb 05             	cmp    $0x5,%ebx
 11d:	75 a1                	jne    c0 <procon+0x10>
    printf(1, "Full queue.\n");
 11f:	83 ec 08             	sub    $0x8,%esp
 122:	68 e6 08 00 00       	push   $0x8e6
 127:	6a 01                	push   $0x1
 129:	e8 32 04 00 00       	call   560 <printf>
}
 12e:	83 c4 10             	add    $0x10,%esp
 131:	8d 65 f8             	lea    -0x8(%ebp),%esp
 134:	5b                   	pop    %ebx
 135:	5e                   	pop    %esi
 136:	5d                   	pop    %ebp
 137:	c3                   	ret    
...
printf(int fd, const char *fmt, ...)
{
 ...
 6e4:	eb 1a                	jmp    700 <printf+0x1a0>
          s = "(null)";
 6e6:	bb f3 08 00 00       	mov    $0x8f3,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 735:	a1 d4 0b 00 00       	mov    0xbd4,%eax
{
 ...
 756:	73 10                	jae    768 <free+0x38>
{
 ...
 781:	5b                   	pop    %ebx
  freep = p;
 782:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 787:	5e                   	pop    %esi
 788:	5f                   	pop    %edi
 789:	5d                   	pop    %ebp
 ...
 7a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7aa:	a3 d4 0b 00 00       	mov    %eax,0xbd4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7d0:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 819:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
 ...
 842:	e8 e9 fe ff ff       	call   730 <free>
  return freep;
 847:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 ...
 874:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 877:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 ...
 88e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 890:	c7 05 d4 0b 00 00 d8 	movl   $0xbd8,0xbd4
 897:	0b 00 00 
    base.s.size = 0;
 89a:	bf d8 0b 00 00       	mov    $0xbd8,%edi
    base.s.ptr = freep = prevp = &base;
 89f:	c7 05 d8 0b 00 00 d8 	movl   $0xbd8,0xbd8
 8a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
