...
int main(int argc, char *argv[])
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    ...
    {
        id = fork();
  15:	e8 d1 02 00 00       	call   2eb <fork>
        if(id < 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	78 1c                	js     3a <main+0x3a>
            printf(1, "%d failed in fork!\n", getpid());
        else if(id > 0) {
  1e:	74 4a                	je     6a <main+0x6a>
            wait();
  20:	e8 d6 02 00 00       	call   2fb <wait>
        id = fork();
  25:	e8 c1 02 00 00       	call   2eb <fork>
        if(id < 0)
  2a:	85 c0                	test   %eax,%eax
  2c:	78 24                	js     52 <main+0x52>
        else if(id > 0) {
  2e:	74 3a                	je     6a <main+0x6a>
            wait();
  30:	e8 c6 02 00 00       	call   2fb <wait>
    ...
    exit();
  35:	e8 b9 02 00 00       	call   2f3 <exit>
            printf(1, "%d failed in fork!\n", getpid());
  3a:	e8 34 03 00 00       	call   373 <getpid>
  3f:	51                   	push   %ecx
  40:	50                   	push   %eax
  ...
  50:	eb d3                	jmp    25 <main+0x25>
  52:	e8 1c 03 00 00       	call   373 <getpid>
  57:	52                   	push   %edx
  58:	50                   	push   %eax
  59:	68 18 08 00 00       	push   $0x818
  5e:	6a 01                	push   $0x1
  60:	e8 4b 04 00 00       	call   4b0 <printf>
  65:	83 c4 10             	add    $0x10,%esp
  68:	eb cb                	jmp    35 <main+0x35>
            for(z=0;z<end;z+=0.001)
  6a:	d9 ee                	fldz   
  6c:	dd 05 30 08 00 00    	fldl   0x830
  72:	dc c1                	fadd   %st,%st(1)
  74:	d9 05 38 08 00 00    	flds   0x838
  7a:	df f2                	fcomip %st(2),%st
  7c:	77 f4                	ja     72 <main+0x72>
  7e:	dd d8                	fstp   %st(0)
  80:	dd d8                	fstp   %st(0)
  82:	eb b1                	jmp    35 <main+0x35>
  84:	66 90                	xchg   %ax,%ax
  86:	66 90                	xchg   %ax,%ax
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
...
00000393 <find_next_prime_number>:
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 47e:	56                   	push   %esi
 47f:	57                   	push   %edi
 480:	e8 8e fe ff ff       	call   313 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
 ...
 559:	e8 b5 fd ff ff       	call   313 <write>
        putc(fd, c);
      } else {
 ...
 5e1:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 5e4:	e8 2a fd ff ff       	call   313 <write>
        ap++;
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 3c 08 00 00       	mov    $0x83c,%ebx
        while(*s != 0){
 ...
 65b:	57                   	push   %edi
 65c:	53                   	push   %ebx
 65d:	e8 b1 fc ff ff       	call   313 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 ec 0a 00 00       	mov    0xaec,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d ec 0a 00 00    	mov    0xaec,%edi
 ...
 77b:	e8 fb fb ff ff       	call   37b <sbrk>
  if(p == (char*)-1)
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 ec 0a 00 00       	mov    0xaec,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 ec 0a 00 00       	mov    %eax,0xaec
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 ec 0a 00 00 f0 	movl   $0xaf0,0xaec
 7e7:	0a 00 00 
    base.s.size = 0;
 7ea:	bf f0 0a 00 00       	mov    $0xaf0,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 f0 0a 00 00 f0 	movl   $0xaf0,0xaf0
 7f6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 f4 0a 00 00 00 	movl   $0x0,0xaf4
 802:	00 00 00 
    if(p->s.size >= nunits){
