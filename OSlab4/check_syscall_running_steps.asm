...
int main(int argc, char *argv[])
{
  ...
  20:	52                   	push   %edx
  21:	50                   	push   %eax
  22:	68 c8 07 00 00       	push   $0x7c8
  27:	6a 01                	push   $0x1
  29:	e8 32 04 00 00       	call   460 <printf>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb d4 07 00 00       	mov    $0x7d4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 84 0a 00 00       	mov    0xa84,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 84 0a 00 00       	mov    %eax,0xa84
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 84 0a 00 00    	mov    0xa84,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 84 0a 00 00       	mov    %eax,0xa84
}
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 88 0a 00 00       	mov    $0xa88,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 88 0a 00 00 88 	movl   $0xa88,0xa88
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 7b2:	00 00 00 
    if(p->s.size >= nunits){
