...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 0d 08 00 00       	mov    $0x80d,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
 ...
 6d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6da:	a3 c8 0a 00 00       	mov    %eax,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
