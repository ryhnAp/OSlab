...
_change_queue:     file format elf32-i386
  ...
  17:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  30:	e8 1b 02 00 00       	call   250 <atoi>
    ...
    change_queue(arg1, arg2);
  35:	59                   	pop    %ecx
  36:	5e                   	pop    %esi
  37:	50                   	push   %eax
  38:	53                   	push   %ebx
  39:	e8 45 03 00 00       	call   383 <change_queue>
...
free(void *ap)
{
 ...
 655:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
 ...
 762:	e8 e9 fe ff ff       	call   650 <free>
  return freep;
 767:	a1 b4 0a 00 00       	mov    0xab4,%eax
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 b4 0a 00 00       	mov    %eax,0xab4
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf b8 0a 00 00       	mov    $0xab8,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 7d2:	00 00 00 
    if(p->s.size >= nunits){
