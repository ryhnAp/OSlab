...
80100048:	bb 18 b6 10 80       	mov    $0x8010b618,%ebx
{
...
80100062:	b8 58 fd 10 80       	mov    $0x8010fd58,%eax
  bcache.head.prev = &bcache.head;
80100067:	c7 05 ac fd 10 80 58 	movl   $0x8010fd58,0x8010fdac
8010006e:	fd 10 80 
  bcache.head.next = &bcache.head;
80100071:	c7 05 b0 fd 10 80 58 	movl   $0x8010fd58,0x8010fdb0
80100078:	fd 10 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d b0 fd 10 80    	mov    %ebx,0x8010fdb0
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb f8 fa 10 80    	cmp    $0x8010faf8,%ebx
...
801000ed:	8b 1d b0 fd 10 80    	mov    0x8010fdb0,%ebx
801000f3:	83 c4 10             	add    $0x10,%esp
801000f6:	81 fb 58 fd 10 80    	cmp    $0x8010fd58,%ebx
...
80100243:	89 50 58             	mov    %edx,0x58(%eax)
    b->next = bcache.head.next;
80100246:	a1 b0 fd 10 80       	mov    0x8010fdb0,%eax
    b->prev = &bcache.head;
8010024b:	c7 43 54 58 fd 10 80 	movl   $0x8010fd58,0x54(%ebx)
    b->next = bcache.head.next;
80100252:	89 43 58             	mov    %eax,0x58(%ebx)
    bcache.head.next->prev = b;
80100255:	a1 b0 fd 10 80       	mov    0x8010fdb0,%eax
8010025a:	89 58 54             	mov    %ebx,0x54(%eax)
    bcache.head.next = b;
8010025d:	89 1d b0 fd 10 80    	mov    %ebx,0x8010fdb0
  }
...
801002c6:	a1 40 00 11 80       	mov    0x80110040,%eax
801002cb:	3b 05 44 00 11 80    	cmp    0x80110044,%eax
...
801002e0:	68 40 00 11 80       	push   $0x80110040
801002e5:	e8 36 3c 00 00       	call   80103f20 <sleep>
    while(input.r == input.w){
801002ea:	a1 40 00 11 80       	mov    0x80110040,%eax
801002ef:	83 c4 10             	add    $0x10,%esp
801002f2:	3b 05 44 00 11 80    	cmp    0x80110044,%eax
...
80100333:	89 15 40 00 11 80    	mov    %edx,0x80110040
80100339:	89 c2                	mov    %eax,%edx
8010033b:	83 e2 7f             	and    $0x7f,%edx
8010033e:	0f be 8a c0 ff 10 80 	movsbl -0x7fef0040(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100384:	73 d7                	jae    8010035d <consoleread+0xcd>
        input.r--;
80100386:	a3 40 00 11 80       	mov    %eax,0x80110040
...
8010039c:	fa                   	cli    
  cons.locking = 0;
8010039d:	c7 05 58 a5 10 80 00 	movl   $0x0,0x8010a558
801003a4:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 8b 7d 10 80 	movl   $0x80107d8b,(%esp)
...
8010042a:	e8 81 5b 00 00       	call   80105fb0 <uartputc>
...
80100515:	e8 96 5a 00 00       	call   80105fb0 <uartputc>
8010051a:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100521:	e8 8a 5a 00 00       	call   80105fb0 <uartputc>
80100526:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052d:	e8 7e 5a 00 00       	call   80105fb0 <uartputc>
...
80100600:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100603:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
...
8010066e:	8d 34 1f             	lea    (%edi,%ebx,1),%esi
  if(panicked){
80100671:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
...
801006bd:	a1 58 a5 10 80       	mov    0x8010a558,%eax
...
801006ea:	74 44                	je     80100730 <cprintf+0x80>
  if(panicked){
801006ec:	8b 0d 5c a5 10 80    	mov    0x8010a55c,%ecx
...
80100782:	b8 28 00 00 00       	mov    $0x28,%eax
  if(panicked){
80100787:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
...
801007db:	e9 2a ff ff ff       	jmp    8010070a <cprintf+0x5a>
  if(panicked){
801007e0:	8b 3d 5c a5 10 80    	mov    0x8010a55c,%edi
...
801007f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(panicked){
801007f8:	8b 0d 5c a5 10 80    	mov    0x8010a55c,%ecx
...
8010080d:	e8 fe fb ff ff       	call   80100410 <consputc.part.0>
  if(panicked){
80100812:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
...
801008b4:	a1 48 00 11 80       	mov    0x80110048,%eax
801008b9:	89 c2                	mov    %eax,%edx
801008bb:	2b 15 40 00 11 80    	sub    0x80110040,%edx
801008c1:	83 fa 7f             	cmp    $0x7f,%edx
801008c4:	77 d2                	ja     80100898 <consoleintr+0x38>
        c = (c == '\r') ? '\n' : c;
801008c6:	8d 48 01             	lea    0x1(%eax),%ecx
801008c9:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
801008cf:	83 e0 7f             	and    $0x7f,%eax
        input.buf[input.e++ % INPUT_BUF] = c;
801008d2:	89 0d 48 00 11 80    	mov    %ecx,0x80110048
        c = (c == '\r') ? '\n' : c;
801008d8:	83 fb 0d             	cmp    $0xd,%ebx
801008db:	0f 84 02 01 00 00    	je     801009e3 <consoleintr+0x183>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e1:	88 98 c0 ff 10 80    	mov    %bl,-0x7fef0040(%eax)
  if(panicked){
...
80100908:	a1 40 00 11 80       	mov    0x80110040,%eax
8010090d:	83 e8 80             	sub    $0xffffff80,%eax
80100910:	39 05 48 00 11 80    	cmp    %eax,0x80110048
80100916:	75 80                	jne    80100898 <consoleintr+0x38>
80100918:	e9 f6 00 00 00       	jmp    80100a13 <consoleintr+0x1b3>
8010091d:	8d 76 00             	lea    0x0(%esi),%esi
      while(input.e != input.w &&
80100920:	a1 48 00 11 80       	mov    0x80110048,%eax
80100925:	39 05 44 00 11 80    	cmp    %eax,0x80110044
...
80100936:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100939:	80 ba c0 ff 10 80 0a 	cmpb   $0xa,-0x7fef0040(%edx)
80100940:	0f 84 52 ff ff ff    	je     80100898 <consoleintr+0x38>
  if(panicked){
80100946:	8b 15 5c a5 10 80    	mov    0x8010a55c,%edx
        input.e--;
8010094c:	a3 48 00 11 80       	mov    %eax,0x80110048
  if(panicked){
...
80100965:	e8 a6 fa ff ff       	call   80100410 <consputc.part.0>
      while(input.e != input.w &&
8010096a:	a1 48 00 11 80       	mov    0x80110048,%eax
8010096f:	3b 05 44 00 11 80    	cmp    0x80110044,%eax
80100975:	75 ba                	jne    80100931 <consoleintr+0xd1>
80100977:	e9 1c ff ff ff       	jmp    80100898 <consoleintr+0x38>
8010097c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      if(input.e != input.w){
80100980:	a1 48 00 11 80       	mov    0x80110048,%eax
80100985:	3b 05 44 00 11 80    	cmp    0x80110044,%eax
8010098b:	0f 84 07 ff ff ff    	je     80100898 <consoleintr+0x38>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 48 00 11 80       	mov    %eax,0x80110048
  if(panicked){
80100999:	a1 5c a5 10 80       	mov    0x8010a55c,%eax
...
801009e2:	c3                   	ret    
        input.buf[input.e++ % INPUT_BUF] = c;
801009e3:	c6 80 c0 ff 10 80 0a 	movb   $0xa,-0x7fef0040(%eax)
  if(panicked){
...
80100a09:	e8 02 fa ff ff       	call   80100410 <consputc.part.0>
        if(c == '\n' || c == C('D') || input.e == input.r+INPUT_BUF){
80100a0e:	a1 48 00 11 80       	mov    0x80110048,%eax
          wakeup(&input.r);
80100a13:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a16:	a3 44 00 11 80       	mov    %eax,0x80110044
          wakeup(&input.r);
80100a1b:	68 40 00 11 80       	push   $0x80110040
...
80100a4d:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a4f:	c7 05 0c 0a 11 80 40 	movl   $0x80100640,0x80110a0c
80100a56:	06 10 80 
  devsw[CONSOLE].read = consoleread;
80100a59:	c7 05 08 0a 11 80 90 	movl   $0x80100290,0x80110a08
80100a60:	02 10 80 
  cons.locking = 1;
80100a63:	c7 05 58 a5 10 80 01 	movl   $0x1,0x8010a558
80100a6a:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100b0a:	75 ce                	jne    80100ada <exec+0x5a>
  if((pgdir = setupkvm()) == 0)
80100b0c:	e8 0f 66 00 00       	call   80107120 <setupkvm>
...
80100b73:	e8 c8 63 00 00       	call   80106f40 <allocuvm>
...
80100ba9:	e8 c2 62 00 00       	call   80106e70 <loaduvm>
...
80100beb:	e8 b0 64 00 00       	call   801070a0 <freevm>
  if(ip){
...
80100c32:	e8 09 63 00 00       	call   80106f40 <allocuvm>
...
80100c51:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c53:	e8 68 65 00 00       	call   801071c0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cc7:	e8 54 66 00 00       	call   80107320 <copyout>
...
80100ce1:	e8 ba 63 00 00       	call   801070a0 <freevm>
...
80100d2d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d33:	e8 e8 65 00 00       	call   80107320 <copyout>
...
80100d9d:	e8 3e 5f 00 00       	call   80106ce0 <switchuvm>
  freevm(oldpgdir);
80100da2:	89 3c 24             	mov    %edi,(%esp)
80100da5:	e8 f6 62 00 00       	call   801070a0 <freevm>
  return 0;
...
80100def:	68 60 00 11 80       	push   $0x80110060
...
80100e08:	bb 98 00 11 80       	mov    $0x80110098,%ebx
{
80100e0d:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e10:	68 60 00 11 80       	push   $0x80110060
...
80100e23:	81 fb f8 09 11 80    	cmp    $0x801109f8,%ebx
...
80100e53:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e55:	68 60 00 11 80       	push   $0x80110060
...
80100e7b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100e7e:	68 60 00 11 80       	push   $0x80110060
...
80100e98:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100e9b:	68 60 00 11 80       	push   $0x80110060
...
80100ecd:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100ed0:	68 60 00 11 80       	push   $0x80110060
...
80100f05:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f08:	68 60 00 11 80       	push   $0x80110060
  ff = *f;
...
80100f2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f30:	c7 45 08 60 00 11 80 	movl   $0x80110060,0x8(%ebp)
}
...
801011b8:	03 05 78 0a 11 80    	add    0x80110a78,%eax
{
...
80101217:	68 7f 74 10 80       	push   $0x8010747f
...
80101239:	8b 0d 60 0a 11 80    	mov    0x80110a60,%ecx
{
...
8010125c:	03 05 78 0a 11 80    	add    0x80110a78,%eax
...
80101271:	a1 60 0a 11 80       	mov    0x80110a60,%eax
...
801012c9:	39 05 60 0a 11 80    	cmp    %eax,0x80110a60
801012cf:	77 80                	ja     80101251 <balloc+0x21>
  panic("balloc: out of blocks");
801012d1:	83 ec 0c             	sub    $0xc,%esp
801012d4:	68 92 74 10 80       	push   $0x80107492
...
8010134a:	bb b8 0a 11 80       	mov    $0x80110ab8,%ebx
{
8010134f:	83 ec 28             	sub    $0x28,%esp
80101352:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101355:	68 80 0a 11 80       	push   $0x80110a80
...
80101374:	81 c3 94 00 00 00    	add    $0x94,%ebx
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010137a:	81 fb a0 27 11 80    	cmp    $0x801127a0,%ebx
...
80101399:	89 c6                	mov    %eax,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010139b:	81 fb a0 27 11 80    	cmp    $0x801127a0,%ebx
...
801013bb:	c7 46 50 00 00 00 00 	movl   $0x0,0x50(%esi)
  release(&icache.lock);
801013c2:	68 80 0a 11 80       	push   $0x80110a80
...
801013eb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013ed:	68 80 0a 11 80       	push   $0x80110a80
      ip->ref++;
...
80101406:	c3                   	ret    
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101407:	81 fb a0 27 11 80    	cmp    $0x801127a0,%ebx
...
80101422:	68 a8 74 10 80       	push   $0x801074a8
...
801014eb:	68 b8 74 10 80       	push   $0x801074b8
...
80101548:	bb c4 0a 11 80       	mov    $0x80110ac4,%ebx
8010154d:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
80101550:	68 cb 74 10 80       	push   $0x801074cb
80101555:	68 80 0a 11 80       	push   $0x80110a80
...
8010157f:	81 fb ac 27 11 80    	cmp    $0x801127ac,%ebx
80101585:	75 e1                	jne    80101568 <iinit+0x28>
  readsb(dev, &sb);
80101587:	83 ec 08             	sub    $0x8,%esp
8010158a:	68 60 0a 11 80       	push   $0x80110a60
8010158f:	ff 75 08             	pushl  0x8(%ebp)
80101592:	e8 69 ff ff ff       	call   80101500 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101597:	ff 35 78 0a 11 80    	pushl  0x80110a78
8010159d:	ff 35 74 0a 11 80    	pushl  0x80110a74
801015a3:	ff 35 70 0a 11 80    	pushl  0x80110a70
801015a9:	ff 35 6c 0a 11 80    	pushl  0x80110a6c
801015af:	ff 35 68 0a 11 80    	pushl  0x80110a68
801015b5:	ff 35 64 0a 11 80    	pushl  0x80110a64
801015bb:	ff 35 60 0a 11 80    	pushl  0x80110a60
...
801015f0:	83 3d 68 0a 11 80 01 	cmpl   $0x1,0x80110a68
{
...
8010161f:	3b 3d 68 0a 11 80    	cmp    0x80110a68,%edi
80101625:	73 69                	jae    80101690 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101627:	89 f8                	mov    %edi,%eax
80101629:	83 ec 08             	sub    $0x8,%esp
8010162c:	c1 e8 03             	shr    $0x3,%eax
8010162f:	03 05 74 0a 11 80    	add    0x80110a74,%eax
...
801016b8:	03 05 74 0a 11 80    	add    0x80110a74,%eax
...
8010173b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010173e:	68 80 0a 11 80       	push   $0x80110a80
80101743:	e8 b8 2f 00 00       	call   80104700 <acquire>
  ip->ref++;
80101748:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
8010174c:	c7 04 24 80 0a 11 80 	movl   $0x80110a80,(%esp)
...
801017a9:	03 05 74 0a 11 80    	add    0x80110a74,%eax
...
801018be:	e8 0d 2c 00 00       	call   801044d0 <releasesleep>
  acquire(&icache.lock);
801018c3:	c7 04 24 80 0a 11 80 	movl   $0x80110a80,(%esp)
801018ca:	e8 31 2e 00 00       	call   80104700 <acquire>
  ip->ref--;
801018cf:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018d3:	83 c4 10             	add    $0x10,%esp
801018d6:	c7 45 08 80 0a 11 80 	movl   $0x80110a80,0x8(%ebp)
}
...
801018f3:	68 80 0a 11 80       	push   $0x80110a80
801018f8:	e8 03 2e 00 00       	call   80104700 <acquire>
    int r = ip->ref;
801018fd:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101900:	c7 04 24 80 0a 11 80 	movl   $0x80110a80,(%esp)
...
80101b3a:	8b 04 c5 00 0a 11 80 	mov    -0x7feef600(,%eax,8),%eax
...
80101c4a:	8b 04 c5 04 0a 11 80 	mov    -0x7feef5fc(,%eax,8),%eax
...
80101d94:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101d97:	68 80 0a 11 80       	push   $0x80110a80
80101d9c:	e8 5f 29 00 00       	call   80104700 <acquire>
  ip->ref++;
80101da1:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101da5:	c7 04 24 80 0a 11 80 	movl   $0x80110a80,(%esp)
...
80102020:	68 72 7b 10 80       	push   $0x80107b72
...
80102169:	58                   	pop    %eax
8010216a:	a1 a0 2e 11 80       	mov    0x80112ea0,%eax
8010216f:	5a                   	pop    %edx
...
80102385:	c7 05 a0 27 11 80 00 	movl   $0xfec00000,0x801127a0
8010238c:	00 c0 fe 
{
...
8010239a:	00 00 00 
  return ioapic->data;
8010239d:	8b 15 a0 27 11 80    	mov    0x801127a0,%edx
801023a3:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023a6:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023ac:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023b2:	0f b6 15 00 29 11 80 	movzbl 0x80112900,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
801023d8:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
...
801023f2:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
801023f4:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
...
8010240c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010240e:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
...
80102434:	55                   	push   %ebp
  ioapic->reg = reg;
80102435:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
{
...
80102447:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102449:	8b 0d a0 27 11 80    	mov    0x801127a0,%ecx
...
80102458:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
8010245a:	a1 a0 27 11 80       	mov    0x801127a0,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
80102486:	81 fb 88 57 11 80    	cmp    $0x80115788,%ebx
...
801024a6:	e8 a5 23 00 00       	call   80104850 <memset>
  ...
  if(kmem.use_lock)
801024ab:	8b 15 f8 27 11 80    	mov    0x801127f8,%edx
...
801024b8:	a1 fc 27 11 80       	mov    0x801127fc,%eax
801024bd:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
801024bf:	a1 f8 27 11 80       	mov    0x801127f8,%eax
  kmem.freelist = r;
801024c4:	89 1d fc 27 11 80    	mov    %ebx,0x801127fc
  if(kmem.use_lock)
...
801024db:	68 c0 27 11 80       	push   $0x801127c0
801024e0:	e8 1b 22 00 00       	call   80104700 <acquire>
801024e5:	83 c4 10             	add    $0x10,%esp
801024e8:	eb ce                	jmp    801024b8 <kfree+0x48>
801024ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
801024f0:	c7 45 08 c0 27 11 80 	movl   $0x801127c0,0x8(%ebp)
}
...
80102574:	68 c0 27 11 80       	push   $0x801127c0
...
80102581:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102584:	c7 05 f8 27 11 80 00 	movl   $0x0,0x801127f8
8010258b:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
80102612:	73 e4                	jae    801025f8 <kinit2+0x28>
  kmem.use_lock = 1;
80102614:	c7 05 f8 27 11 80 01 	movl   $0x1,0x801127f8
8010261b:	00 00 00 
}
...
80102630:	f3 0f 1e fb          	endbr32 
  ...
  if(kmem.use_lock)
80102634:	a1 f8 27 11 80       	mov    0x801127f8,%eax
80102639:	85 c0                	test   %eax,%eax
8010263b:	75 1b                	jne    80102658 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
8010263d:	a1 fc 27 11 80       	mov    0x801127fc,%eax
  if(r)
80102642:	85 c0                	test   %eax,%eax
80102644:	74 0a                	je     80102650 <kalloc+0x20>
    kmem.freelist = r->next;
80102646:	8b 10                	mov    (%eax),%edx
80102648:	89 15 fc 27 11 80    	mov    %edx,0x801127fc
  if(kmem.use_lock)
8010264e:	c3                   	ret    
8010264f:	90                   	nop
    release(&kmem.lock);
...
8010265b:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
8010265e:	68 c0 27 11 80       	push   $0x801127c0
80102663:	e8 98 20 00 00       	call   80104700 <acquire>
  r = kmem.freelist;
80102668:	a1 fc 27 11 80       	mov    0x801127fc,%eax
  if(r)
8010266d:	8b 15 f8 27 11 80    	mov    0x801127f8,%edx
80102673:	83 c4 10             	add    $0x10,%esp
80102676:	85 c0                	test   %eax,%eax
80102678:	74 08                	je     80102682 <kalloc+0x52>
    kmem.freelist = r->next;
8010267a:	8b 08                	mov    (%eax),%ecx
8010267c:	89 0d fc 27 11 80    	mov    %ecx,0x801127fc
  if(kmem.use_lock)
...
8010268c:	68 c0 27 11 80       	push   $0x801127c0
...
801026bb:	ec                   	in     (%dx),%al
  return data;
801026bc:	8b 1d b8 a5 10 80    	mov    0x8010a5b8,%ebx
    return -1;
  data = inb(KBDATAP);
...
801026f1:	89 c8                	mov    %ecx,%eax
  shift ^= togglecode[data];
801026f3:	89 0d b8 a5 10 80    	mov    %ecx,0x8010a5b8
  c = charcode[shift & (CTL | SHIFT)][data];
...
80102723:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102725:	89 1d b8 a5 10 80    	mov    %ebx,0x8010a5b8
}
8010272b:	5b                   	pop    %ebx
8010272c:	5d                   	pop    %ebp
8010272d:	c3                   	ret    
...
8010274c:	5d                   	pop    %ebp
    shift &= ~(shiftcode[data] | E0ESC);
8010274d:	89 0d b8 a5 10 80    	mov    %ecx,0x8010a5b8
}
80102753:	c3                   	ret    
...
801027a0:	f3 0f 1e fb          	endbr32 
  if(!lapic)
801027a4:	a1 00 28 11 80       	mov    0x80112800,%eax
...
801028a0:	f3 0f 1e fb          	endbr32 
  if (!lapic)
801028a4:	a1 00 28 11 80       	mov    0x80112800,%eax
...
801028c0:	f3 0f 1e fb          	endbr32 
  if(lapic)
801028c4:	a1 00 28 11 80       	mov    0x80112800,%eax
...
8010292c:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
80102932:	a1 00 28 11 80       	mov    0x80112800,%eax
...
80102b90:	8b 0d 6c 28 11 80    	mov    0x8011286c,%ecx
...
80102bb0:	a1 58 28 11 80       	mov    0x80112858,%eax
80102bb5:	83 ec 08             	sub    $0x8,%esp
80102bb8:	01 f8                	add    %edi,%eax
80102bba:	83 c0 01             	add    $0x1,%eax
80102bbd:	50                   	push   %eax
80102bbe:	ff 35 68 28 11 80    	pushl  0x80112868
80102bc4:	e8 07 d5 ff ff       	call   801000d0 <bread>
80102bc9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bcb:	58                   	pop    %eax
80102bcc:	5a                   	pop    %edx
80102bcd:	ff 34 bd 70 28 11 80 	pushl  -0x7feed790(,%edi,4)
80102bd4:	ff 35 68 28 11 80    	pushl  0x80112868
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c14:	39 3d 6c 28 11 80    	cmp    %edi,0x8011286c
...
80102c37:	ff 35 58 28 11 80    	pushl  0x80112858
80102c3d:	ff 35 68 28 11 80    	pushl  0x80112868
...
80102c4b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c4d:	a1 6c 28 11 80       	mov    0x8011286c,%eax
...
80102c60:	8b 0c 95 70 28 11 80 	mov    -0x7feed790(,%edx,4),%ecx
...
80102ca3:	68 20 28 11 80       	push   $0x80112820
...
80102cbc:	59                   	pop    %ecx
  log.dev = dev;
80102cbd:	89 1d 68 28 11 80    	mov    %ebx,0x80112868
  log.size = sb.nlog;
80102cc3:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cc6:	a3 58 28 11 80       	mov    %eax,0x80112858
  log.size = sb.nlog;
80102ccb:	89 15 5c 28 11 80    	mov    %edx,0x8011285c
  struct buf *buf = bread(log.dev, log.start);
80102cd1:	5a                   	pop    %edx
...
80102cdf:	89 0d 6c 28 11 80    	mov    %ecx,0x8011286c
  for (i = 0; i < log.lh.n; i++) {
...
80102cf4:	89 1c 95 70 28 11 80 	mov    %ebx,-0x7feed790(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d0b:	e8 80 fe ff ff       	call   80102b90 <install_trans>
  log.lh.n = 0;
80102d10:	c7 05 6c 28 11 80 00 	movl   $0x0,0x8011286c
80102d17:	00 00 00 
...
80102d37:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d3a:	68 20 28 11 80       	push   $0x80112820
...
80102d53:	68 20 28 11 80       	push   $0x80112820
80102d58:	68 20 28 11 80       	push   $0x80112820
80102d5d:	e8 be 11 00 00       	call   80103f20 <sleep>
80102d62:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d65:	a1 64 28 11 80       	mov    0x80112864,%eax
80102d6a:	85 c0                	test   %eax,%eax
80102d6c:	75 e2                	jne    80102d50 <begin_op+0x20>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d6e:	a1 60 28 11 80       	mov    0x80112860,%eax
80102d73:	8b 15 6c 28 11 80    	mov    0x8011286c,%edx
...
80102d87:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102d8a:	a3 60 28 11 80       	mov    %eax,0x80112860
      release(&log.lock);
80102d8f:	68 20 28 11 80       	push   $0x80112820
...
80102daa:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dad:	68 20 28 11 80       	push   $0x80112820
80102db2:	e8 49 19 00 00       	call   80104700 <acquire>
  log.outstanding -= 1;
80102db7:	a1 60 28 11 80       	mov    0x80112860,%eax
  if(log.committing)
80102dbc:	8b 35 64 28 11 80    	mov    0x80112864,%esi
80102dc2:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102dc5:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102dc8:	89 1d 60 28 11 80    	mov    %ebx,0x80112860
  if(log.committing)
...
80102dd8:	0f 85 f2 00 00 00    	jne    80102ed0 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102dde:	c7 05 64 28 11 80 01 	movl   $0x1,0x80112864
80102de5:	00 00 00 
...
80102deb:	68 20 28 11 80       	push   $0x80112820
...
{
  if (log.lh.n > 0) {
80102df5:	8b 0d 6c 28 11 80    	mov    0x8011286c,%ecx
80102dfb:	83 c4 10             	add    $0x10,%esp
80102dfe:	85 c9                	test   %ecx,%ecx
80102e00:	7f 3e                	jg     80102e40 <end_op+0xa0>
    acquire(&log.lock);
80102e02:	83 ec 0c             	sub    $0xc,%esp
80102e05:	68 20 28 11 80       	push   $0x80112820
80102e0a:	e8 f1 18 00 00       	call   80104700 <acquire>
    wakeup(&log);
80102e0f:	c7 04 24 20 28 11 80 	movl   $0x80112820,(%esp)
    log.committing = 0;
80102e16:	c7 05 64 28 11 80 00 	movl   $0x0,0x80112864
80102e1d:	00 00 00 
    wakeup(&log);
80102e20:	e8 bb 12 00 00       	call   801040e0 <wakeup>
    release(&log.lock);
80102e25:	c7 04 24 20 28 11 80 	movl   $0x80112820,(%esp)
...
80102e40:	a1 58 28 11 80       	mov    0x80112858,%eax
80102e45:	83 ec 08             	sub    $0x8,%esp
80102e48:	01 d8                	add    %ebx,%eax
80102e4a:	83 c0 01             	add    $0x1,%eax
80102e4d:	50                   	push   %eax
80102e4e:	ff 35 68 28 11 80    	pushl  0x80112868
80102e54:	e8 77 d2 ff ff       	call   801000d0 <bread>
80102e59:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e5b:	58                   	pop    %eax
80102e5c:	5a                   	pop    %edx
80102e5d:	ff 34 9d 70 28 11 80 	pushl  -0x7feed790(,%ebx,4)
80102e64:	ff 35 68 28 11 80    	pushl  0x80112868
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102ea4:	3b 1d 6c 28 11 80    	cmp    0x8011286c,%ebx
...
80102eb1:	e8 da fc ff ff       	call   80102b90 <install_trans>
    log.lh.n = 0;
80102eb6:	c7 05 6c 28 11 80 00 	movl   $0x0,0x8011286c
80102ebd:	00 00 00 
...
80102ed3:	68 20 28 11 80       	push   $0x80112820
80102ed8:	e8 03 12 00 00       	call   801040e0 <wakeup>
  release(&log.lock);
80102edd:	c7 04 24 20 28 11 80 	movl   $0x80112820,(%esp)
...
80102f1b:	8b 15 6c 28 11 80    	mov    0x8011286c,%edx
{
80102f21:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f24:	83 fa 1d             	cmp    $0x1d,%edx
80102f27:	0f 8f 91 00 00 00    	jg     80102fbe <log_write+0xae>
80102f2d:	a1 5c 28 11 80       	mov    0x8011285c,%eax
80102f32:	83 e8 01             	sub    $0x1,%eax
80102f35:	39 c2                	cmp    %eax,%edx
80102f37:	0f 8d 81 00 00 00    	jge    80102fbe <log_write+0xae>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f3d:	a1 60 28 11 80       	mov    0x80112860,%eax
...
80102f4d:	68 20 28 11 80       	push   $0x80112820
80102f52:	e8 a9 17 00 00       	call   80104700 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f57:	8b 15 6c 28 11 80    	mov    0x8011286c,%edx
...
80102f75:	74 29                	je     80102fa0 <log_write+0x90>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f77:	39 0c 85 70 28 11 80 	cmp    %ecx,-0x7feed790(,%eax,4)
80102f7e:	75 f0                	jne    80102f70 <log_write+0x60>
      break;
  }
  log.lh.block[i] = b->blockno;
80102f80:	89 0c 85 70 28 11 80 	mov    %ecx,-0x7feed790(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102f8a:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102f8d:	c7 45 08 20 28 11 80 	movl   $0x80112820,0x8(%ebp)
}
80102f94:	c9                   	leave  
  release(&log.lock);
...
80102f9a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 95 70 28 11 80 	mov    %ecx,-0x7feed790(,%edx,4)
    log.lh.n++;
80102fa7:	83 c2 01             	add    $0x1,%edx
80102faa:	89 15 6c 28 11 80    	mov    %edx,0x8011286c
80102fb0:	eb d5                	jmp    80102f87 <log_write+0x77>
  log.lh.block[i] = b->blockno;
80102fb2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fb5:	a3 70 28 11 80       	mov    %eax,0x80112870
  if (i == log.lh.n)
...
80103002:	e8 e9 2b 00 00       	call   80105bf0 <idtinit>
...
80103027:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
8010302a:	e8 91 3c 00 00       	call   80106cc0 <switchkvm>
  seginit();
8010302f:	e8 fc 3b 00 00       	call   80106c30 <seginit>
  lapicinit();
...
8010305b:	68 88 57 11 80       	push   $0x80115788
80103060:	e8 fb f4 ff ff       	call   80102560 <kinit1>
  kvmalloc();      // kernel page table
80103065:	e8 36 41 00 00       	call   801071a0 <kvmalloc>
  mpinit();        // detect other processors
8010306a:	e8 81 01 00 00       	call   801031f0 <mpinit>
  lapicinit();     // interrupt controller
8010306f:	e8 2c f7 ff ff       	call   801027a0 <lapicinit>
  seginit();       // segment descriptors
80103074:	e8 b7 3b 00 00       	call   80106c30 <seginit>
  picinit();       // disable pic
...
80103088:	e8 63 2e 00 00       	call   80105ef0 <uartinit>
  pinit();         // process table
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 d9 2a 00 00       	call   80105b70 <tvinit>
  binit();         // buffer cache
...
801030c0:	69 05 a0 2e 11 80 b0 	imul   $0xb0,0x80112ea0,%eax
801030c7:	00 00 00 
801030ca:	05 20 29 11 80       	add    $0x80112920,%eax
801030cf:	3d 20 29 11 80       	cmp    $0x80112920,%eax
801030d4:	76 7a                	jbe    80103150 <main+0x110>
801030d6:	bb 20 29 11 80       	mov    $0x80112920,%ebx
801030db:	eb 1c                	jmp    801030f9 <main+0xb9>
801030dd:	8d 76 00             	lea    0x0(%esi),%esi
801030e0:	69 05 a0 2e 11 80 b0 	imul   $0xb0,0x80112ea0,%eax
801030e7:	00 00 00 
801030ea:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801030f0:	05 20 29 11 80       	add    $0x80112920,%eax
...
8010319e:	68 b8 78 10 80       	push   $0x801078b8
...
8010325a:	68 bd 78 10 80       	push   $0x801078bd
...
801032be:	a3 00 28 11 80       	mov    %eax,0x80112800
...
8010334c:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
8010334f:	88 0d 00 29 11 80    	mov    %cl,0x80112900
      continue;
80103355:	eb 89                	jmp    801032e0 <mpinit+0xf0>
80103357:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010335e:	66 90                	xchg   %ax,%ax
      if(ncpu < NCPU) {
80103360:	8b 0d a0 2e 11 80    	mov    0x80112ea0,%ecx
...
80103378:	89 0d a0 2e 11 80    	mov    %ecx,0x80112ea0
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f 20 29 11 80    	mov    %bl,-0x7feed6e0(%edi)
...
801033b3:	68 c2 78 10 80       	push   $0x801078c2
801033b8:	e8 d3 cf ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801033bd:	83 ec 0c             	sub    $0xc,%esp
801033c0:	68 dc 78 10 80       	push   $0x801078dc
...
80103464:	00 00 00 
  initlock(&p->lock, "pipe");
80103467:	68 fb 78 10 80       	push   $0x801078fb
...
80103794:	bb 38 30 11 80       	mov    $0x80113038,%ebx
{
80103799:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010379c:	68 00 30 11 80       	push   $0x80113000
...
801037b3:	81 fb 38 4f 11 80    	cmp    $0x80114f38,%ebx
...
801037d4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037d7:	68 00 30 11 80       	push   $0x80113000
  p->pid = nextpid++;
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 64 5b 10 80 	movl   $0x80105b64,0x14(%eax)
  p->context = (struct context*)sp;
...
80103833:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103835:	68 00 30 11 80       	push   $0x80113000
...
80103867:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
8010386a:	68 00 30 11 80       	push   $0x80113000
...
801038ba:	68 00 79 10 80       	push   $0x80107900
801038bf:	68 00 30 11 80       	push   $0x80113000
801038c4:	e8 a7 0c 00 00       	call   80104570 <initlock>
}
...
801038e0:	e8 bb ef ff ff       	call   801028a0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
801038e5:	8b 35 a0 2e 11 80    	mov    0x80112ea0,%esi
  apicid = lapicid();
...
80103905:	0f b6 81 20 29 11 80 	movzbl -0x7feed6e0(%ecx),%eax
8010390c:	39 d8                	cmp    %ebx,%eax
8010390e:	75 e8                	jne    801038f8 <mycpu+0x28>
}
80103910:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
80103913:	8d 81 20 29 11 80    	lea    -0x7feed6e0(%ecx),%eax
}
80103919:	5b                   	pop    %ebx
8010391a:	5e                   	pop    %esi
8010391b:	5d                   	pop    %ebp
...
8010394f:	c9                   	leave  
  return mycpu()-cpus;
80103950:	2d 20 29 11 80       	sub    $0x80112920,%eax
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 90 0c 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 d0 0c 00 00       	call   80104650 <popcli>
}
...
801039a7:	e8 74 37 00 00       	call   80107120 <setupkvm>
...
801039c5:	e8 26 34 00 00       	call   80106df0 <inituvm>
...
80103a33:	68 30 79 10 80       	push   $0x80107930
80103a38:	50                   	push   %eax
80103a39:	e8 d2 0f 00 00       	call   80104a10 <safestrcpy>
  p->cwd = namei("/");
80103a3e:	c7 04 24 39 79 10 80 	movl   $0x80107939,(%esp)
80103a45:	e8 e6 e5 ff ff       	call   80102030 <namei>
80103a4a:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a4d:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
80103a54:	e8 a7 0c 00 00       	call   80104700 <acquire>
  p->state = RUNNABLE;
80103a59:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a60:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
...
80103a77:	68 17 79 10 80       	push   $0x80107917
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 5f 0b 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 9f 0b 00 00       	call   80104650 <popcli>
  sz = curproc->sz;
...
80103abf:	e8 1c 32 00 00       	call   80106ce0 <switchuvm>
  return 0;
...
80103ada:	e8 61 34 00 00       	call   80106f40 <allocuvm>
...
80103afa:	e8 71 35 00 00       	call   80107070 <deallocuvm>
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 de 0a 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 1e 0b 00 00       	call   80104650 <popcli>
  if((np = allocproc()) == 0){
...
80103b4c:	e8 9f 36 00 00       	call   801071f0 <copyuvm>
...
80103bce:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bd1:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
80103bd8:	e8 23 0b 00 00       	call   80104700 <acquire>
  np->state = RUNNABLE;
80103bdd:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103be4:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
...
80103c59:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c5c:	bb 38 30 11 80       	mov    $0x80113038,%ebx
    acquire(&ptable.lock);
80103c61:	68 00 30 11 80       	push   $0x80113000
80103c66:	e8 95 0a 00 00       	call   80104700 <acquire>
...
80103c92:	e8 dc 0d 00 00       	call   80104a73 <swtch>
      switchkvm();
80103c97:	e8 24 30 00 00       	call   80106cc0 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb 38 4f 11 80    	cmp    $0x80114f38,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 00 30 11 80       	push   $0x80113000
...
80103cd8:	53                   	push   %ebx
  pushcli();
80103cd9:	e8 22 09 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103cde:	e8 ed fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103ce3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ce9:	e8 62 09 00 00       	call   80104650 <popcli>
  if(!holding(&ptable.lock))
80103cee:	83 ec 0c             	sub    $0xc,%esp
80103cf1:	68 00 30 11 80       	push   $0x80113000
80103cf6:	e8 b5 09 00 00       	call   801046b0 <holding>
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 5e 08 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 9e 08 00 00       	call   80104650 <popcli>
  if(curproc == initproc)
...
80103dfc:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103e03:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
80103e0a:	e8 f1 08 00 00       	call   80104700 <acquire>
...
80103ead:	68 88 79 10 80       	push   $0x80107988
80103eb2:	e8 d9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 7b 79 10 80       	push   $0x8010797b
...
80103edb:	68 00 30 11 80       	push   $0x80113000
80103ee0:	e8 1b 08 00 00       	call   80104700 <acquire>
  pushcli();
80103ee5:	e8 16 07 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 56 07 00 00       	call   80104650 <popcli>
  myproc()->state = RUNNABLE;
80103efa:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  sched();
80103f01:	e8 ca fd ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80103f06:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 c8 06 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 08 07 00 00       	call   80104650 <popcli>
  if(p == 0)
...
80103f54:	81 fe 00 30 11 80    	cmp    $0x80113000,%esi
80103f5a:	74 4c                	je     80103fa8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103f5c:	83 ec 0c             	sub    $0xc,%esp
80103f5f:	68 00 30 11 80       	push   $0x80113000
80103f64:	e8 97 07 00 00       	call   80104700 <acquire>
    release(lk);
...
80103f80:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f87:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 5b 07 00 00       	jmp    80104700 <acquire>
...
80103fc9:	68 9a 79 10 80       	push   $0x8010799a
80103fce:	e8 bd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fd3:	83 ec 0c             	sub    $0xc,%esp
80103fd6:	68 94 79 10 80       	push   $0x80107994
...
80103fe8:	53                   	push   %ebx
  pushcli();
80103fe9:	e8 12 06 00 00       	call   80104600 <pushcli>
  c = mycpu();
80103fee:	e8 dd f8 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103ff3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ff9:	e8 52 06 00 00       	call   80104650 <popcli>
  acquire(&ptable.lock);
80103ffe:	83 ec 0c             	sub    $0xc,%esp
80104001:	68 00 30 11 80       	push   $0x80113000
80104006:	e8 f5 06 00 00       	call   80104700 <acquire>
8010400b:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
8010400e:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104010:	bb 38 30 11 80       	mov    $0x80113038,%ebx
...
80104023:	81 fb 38 4f 11 80    	cmp    $0x80114f38,%ebx
...
80104039:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010403e:	81 fb 38 4f 11 80    	cmp    $0x80114f38,%ebx
...
80104054:	68 00 30 11 80       	push   $0x80113000
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 1a 30 00 00       	call   801070a0 <freevm>
        release(&ptable.lock);
80104086:	c7 04 24 00 30 11 80 	movl   $0x80113000,(%esp)
        p->pid = 0;
...
801040c1:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040c6:	68 00 30 11 80       	push   $0x80113000
...
801040eb:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801040ee:	68 00 30 11 80       	push   $0x80113000
801040f3:	e8 08 06 00 00       	call   80104700 <acquire>
801040f8:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040fb:	b8 38 30 11 80       	mov    $0x80113038,%eax
80104100:	eb 10                	jmp    80104112 <wakeup+0x32>
80104102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104108:	83 c0 7c             	add    $0x7c,%eax
8010410b:	3d 38 4f 11 80       	cmp    $0x80114f38,%eax
...
80104127:	3d 38 4f 11 80       	cmp    $0x80114f38,%eax
8010412c:	75 e4                	jne    80104112 <wakeup+0x32>
  wakeup1(chan);
  release(&ptable.lock);
8010412e:	c7 45 08 00 30 11 80 	movl   $0x80113000,0x8(%ebp)
}
...
8010414b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010414e:	68 00 30 11 80       	push   $0x80113000
80104153:	e8 a8 05 00 00       	call   80104700 <acquire>
80104158:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010415b:	b8 38 30 11 80       	mov    $0x80113038,%eax
80104160:	eb 10                	jmp    80104172 <kill+0x32>
80104162:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104168:	83 c0 7c             	add    $0x7c,%eax
8010416b:	3d 38 4f 11 80       	cmp    $0x80114f38,%eax
...
8010418e:	68 00 30 11 80       	push   $0x80113000
...
801041ab:	68 00 30 11 80       	push   $0x80113000
...
801041dd:	bb a4 30 11 80       	mov    $0x801130a4,%ebx
...
80104214:	74 ea                	je     80104200 <procdump+0x30>
      state = "???";
80104216:	ba ab 79 10 80       	mov    $0x801079ab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010421b:	83 f8 05             	cmp    $0x5,%eax
8010421e:	77 11                	ja     80104231 <procdump+0x61>
80104220:	8b 14 85 3c 7a 10 80 	mov    -0x7fef85c4(,%eax,4),%edx
      state = "???";
80104227:	b8 ab 79 10 80       	mov    $0x801079ab,%eax
...
80104236:	68 af 79 10 80       	push   $0x801079af
...
8010425d:	e8 3e 03 00 00       	call   801045a0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104275:	68 01 74 10 80       	push   $0x80107401
...
801042b0:	c1 e3 06             	shl    $0x6,%ebx
801042b3:	8d bb c8 2e 11 80    	lea    -0x7feed138(%ebx),%edi
801042b9:	57                   	push   %edi
801042ba:	e8 41 04 00 00       	call   80104700 <acquire>

  if (sema[i].active == 0) 
801042bf:	8b b3 c4 2e 11 80    	mov    -0x7feed13c(%ebx),%esi
801042c5:	83 c4 10             	add    $0x10,%esp
801042c8:	85 f6                	test   %esi,%esi
801042ca:	75 2c                	jne    801042f8 <sem_init+0x58>
  {
    sema[i].active = 1;
801042cc:	c7 83 c4 2e 11 80 01 	movl   $0x1,-0x7feed13c(%ebx)
801042d3:	00 00 00 
  else 
  {
    return -1;
...
801042d6:	83 ec 0c             	sub    $0xc,%esp
    sema[i].value = value;
801042d9:	8b 45 0c             	mov    0xc(%ebp),%eax
  release(&sema[i].lock);
801042dc:	57                   	push   %edi
    sema[i].value = value;
801042dd:	89 83 c0 2e 11 80    	mov    %eax,-0x7feed140(%ebx)
  release(&sema[i].lock);
...
801042f5:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
801042f8:	be ff ff ff ff       	mov    $0xffffffff,%esi
801042fd:	eb ec                	jmp    801042eb <sem_init+0x4b>
801042ff:	90                   	nop

80104300 <sem_acquire>:
...
8010430d:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104310:	c1 e3 06             	shl    $0x6,%ebx
  acquire(&sema[i].lock);
80104313:	8d b3 c8 2e 11 80    	lea    -0x7feed138(%ebx),%esi
80104319:	56                   	push   %esi
8010431a:	e8 e1 03 00 00       	call   80104700 <acquire>

  if (sema[i].value >= 1) 
8010431f:	8b 83 c0 2e 11 80    	mov    -0x7feed140(%ebx),%eax
80104325:	83 c4 10             	add    $0x10,%esp
80104328:	85 c0                	test   %eax,%eax
8010432a:	7e 24                	jle    80104350 <sem_acquire+0x50>
...
8010432c:	83 ec 0c             	sub    $0xc,%esp
    sema[i].value = sema[i].value - 1;
8010432f:	83 e8 01             	sub    $0x1,%eax
  release(&sema[i].lock);
80104332:	56                   	push   %esi
    sema[i].value = sema[i].value - 1;
80104333:	89 83 c0 2e 11 80    	mov    %eax,-0x7feed140(%ebx)
  release(&sema[i].lock);
80104339:	e8 b2 04 00 00       	call   801047f0 <release>
...
8010434f:	90                   	nop
80104350:	8d bb c0 2e 11 80    	lea    -0x7feed140(%ebx),%edi
...
8010436a:	8b 83 c0 2e 11 80    	mov    -0x7feed140(%ebx),%eax
80104370:	83 c4 10             	add    $0x10,%esp
80104373:	85 c0                	test   %eax,%eax
80104375:	7e e9                	jle    80104360 <sem_acquire+0x60>
80104377:	eb b3                	jmp    8010432c <sem_acquire+0x2c>
80104379:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi

80104380 <sem_release>:
...
8010438c:	c1 e3 06             	shl    $0x6,%ebx
  acquire(&sema[i].lock);
8010438f:	83 ec 0c             	sub    $0xc,%esp
80104392:	8d b3 c8 2e 11 80    	lea    -0x7feed138(%ebx),%esi
80104398:	56                   	push   %esi
80104399:	e8 62 03 00 00       	call   80104700 <acquire>

  sema[i].value += 1;
8010439e:	8d 83 c0 2e 11 80    	lea    -0x7feed140(%ebx),%eax
801043a4:	83 83 c0 2e 11 80 01 	addl   $0x1,-0x7feed140(%ebx)
  wakeup(&sema[i]);
801043ab:	89 04 24             	mov    %eax,(%esp)
801043ae:	e8 2d fd ff ff       	call   801040e0 <wakeup>
  release(&sema[i].lock);
801043b3:	89 34 24             	mov    %esi,(%esp)
801043b6:	e8 35 04 00 00       	call   801047f0 <release>
...
801043db:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (count == 0)
801043de:	85 db                	test   %ebx,%ebx
801043e0:	74 3e                	je     80104420 <reentrant+0x50>
  {
    release(&tickslock);
    return;
  }
...
801043e6:	68 b8 79 10 80       	push   $0x801079b8
801043eb:	e8 c0 c2 ff ff       	call   801006b0 <cprintf>
  acquire(&tickslock);
801043f0:	c7 04 24 40 4f 11 80 	movl   $0x80114f40,(%esp)
801043f7:	e8 04 03 00 00       	call   80104700 <acquire>
  reentrant(count - 1); 
801043fc:	8d 43 ff             	lea    -0x1(%ebx),%eax
801043ff:	89 04 24             	mov    %eax,(%esp)
80104402:	e8 c9 ff ff ff       	call   801043d0 <reentrant>
  cprintf("Releasing the %d shift\n", count);
80104407:	58                   	pop    %eax
80104408:	5a                   	pop    %edx
80104409:	53                   	push   %ebx
8010440a:	68 d0 79 10 80       	push   $0x801079d0
8010440f:	e8 9c c2 ff ff       	call   801006b0 <cprintf>
}
...
8010441c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    release(&tickslock);
80104420:	c7 45 08 40 4f 11 80 	movl   $0x80114f40,0x8(%ebp)
}
80104427:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010442a:	c9                   	leave  
    release(&tickslock);
8010442b:	e9 c0 03 00 00       	jmp    801047f0 <release>
...
8010443e:	68 54 7a 10 80       	push   $0x80107a54
...
80104455:	83 c4 10             	add    $0x10,%esp
  lk->pid = 0;
80104458:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  lk->name = name;
8010445f:	89 43 3c             	mov    %eax,0x3c(%ebx)
}
...
80104483:	e8 78 02 00 00       	call   80104700 <acquire>
  while (lk->locked) {
...
8010449d:	e8 7e fa ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
801044ab:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
801044b1:	e8 aa f4 ff ff       	call   80103960 <myproc>
801044b6:	8b 40 10             	mov    0x10(%eax),%eax
801044b9:	89 43 40             	mov    %eax,0x40(%ebx)
  release(&lk->lk);
...
801044c4:	5d                   	pop    %ebp
  release(&lk->lk);
801044c5:	e9 26 03 00 00       	jmp    801047f0 <release>
...
801044e3:	e8 18 02 00 00       	call   80104700 <acquire>
  lk->locked = 0;
801044e8:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801044ee:	c7 43 40 00 00 00 00 	movl   $0x0,0x40(%ebx)
  wakeup(lk);
801044f5:	89 1c 24             	mov    %ebx,(%esp)
801044f8:	e8 e3 fb ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
80104508:	5d                   	pop    %ebp
  release(&lk->lk);
80104509:	e9 e2 02 00 00       	jmp    801047f0 <release>
...
80104526:	e8 d5 01 00 00       	call   80104700 <acquire>
...
80104538:	e8 b3 02 00 00       	call   801047f0 <release>
  return r;
}
...
8010454e:	66 90                	xchg   %ax,%ax
  r = lk->locked && (lk->pid == myproc()->pid);
80104550:	8b 5b 40             	mov    0x40(%ebx),%ebx
80104553:	e8 08 f4 ff ff       	call   80103960 <myproc>
...
80104586:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
  lk->pid = -1;
8010458d:	c7 40 34 ff ff ff ff 	movl   $0xffffffff,0x34(%eax)
...
8010462f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104630:	e8 9b f2 ff ff       	call   801038d0 <mycpu>
...
8010467f:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104680:	e8 4b f2 ff ff       	call   801038d0 <mycpu>
...
80104695:	68 5f 7a 10 80       	push   $0x80107a5f
8010469a:	e8 f1 bc ff ff       	call   80100390 <panic>
    panic("popcli");
8010469f:	83 ec 0c             	sub    $0xc,%esp
801046a2:	68 76 7a 10 80       	push   $0x80107a76
...
801046db:	e8 f0 f1 ff ff       	call   801038d0 <mycpu>
...
80104708:	be 01 00 00 00       	mov    $0x1,%esi
8010470d:	53                   	push   %ebx
  pushcli(); // disable interrupts to avoid deadlock.
8010470e:	e8 ed fe ff ff       	call   80104600 <pushcli>
  if(myproc() != ((void *)0))
80104713:	e8 48 f2 ff ff       	call   80103960 <myproc>
80104718:	85 c0                	test   %eax,%eax
8010471a:	74 08                	je     80104724 <acquire+0x24>
    curr_pid = myproc()->pid;
8010471c:	e8 3f f2 ff ff       	call   80103960 <myproc>
80104721:	8b 70 10             	mov    0x10(%eax),%esi
  if(holding(lk) && lk->pid == curr_pid)
80104724:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104727:	83 ec 0c             	sub    $0xc,%esp
8010472a:	53                   	push   %ebx
8010472b:	e8 80 ff ff ff       	call   801046b0 <holding>
80104730:	83 c4 10             	add    $0x10,%esp
80104733:	85 c0                	test   %eax,%eax
80104735:	74 09                	je     80104740 <acquire+0x40>
80104737:	39 73 34             	cmp    %esi,0x34(%ebx)
8010473a:	0f 84 a4 00 00 00    	je     801047e4 <acquire+0xe4>
  if(holding(lk) && lk->pid != curr_pid)
80104740:	83 ec 0c             	sub    $0xc,%esp
80104743:	53                   	push   %ebx
80104744:	e8 67 ff ff ff       	call   801046b0 <holding>
80104749:	83 c4 10             	add    $0x10,%esp
8010474c:	85 c0                	test   %eax,%eax
8010474e:	75 60                	jne    801047b0 <acquire+0xb0>
80104750:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80104753:	b9 01 00 00 00       	mov    $0x1,%ecx
80104758:	eb 08                	jmp    80104762 <acquire+0x62>
8010475a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104760:	89 d3                	mov    %edx,%ebx
80104762:	89 c8                	mov    %ecx,%eax
80104764:	f0 87 03             	lock xchg %eax,(%ebx)
  while(xchg(&lk->locked, 1) != 0)
80104767:	85 c0                	test   %eax,%eax
80104769:	75 f5                	jne    80104760 <acquire+0x60>
  lk->pid = curr_pid;
8010476b:	89 72 34             	mov    %esi,0x34(%edx)
  __sync_synchronize();
8010476e:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80104773:	8b 5d 08             	mov    0x8(%ebp),%ebx
80104776:	e8 55 f1 ff ff       	call   801038d0 <mycpu>
  ebp = (uint*)v - 2;
8010477b:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
8010477d:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
80104780:	31 c0                	xor    %eax,%eax
80104782:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104788:	8d 8a 00 00 00 80    	lea    -0x80000000(%edx),%ecx
8010478e:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
80104794:	77 32                	ja     801047c8 <acquire+0xc8>
    pcs[i] = ebp[1];     // saved %eip
80104796:	8b 4a 04             	mov    0x4(%edx),%ecx
80104799:	89 4c 83 0c          	mov    %ecx,0xc(%ebx,%eax,4)
  for(i = 0; i < 10; i++){
8010479d:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
801047a0:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
801047a2:	83 f8 0a             	cmp    $0xa,%eax
801047a5:	75 e1                	jne    80104788 <acquire+0x88>
}
...
801047ae:	66 90                	xchg   %ax,%ax
  if(holding(lk) && lk->pid != curr_pid)
801047b0:	39 73 34             	cmp    %esi,0x34(%ebx)
801047b3:	74 9b                	je     80104750 <acquire+0x50>
    panic("acquire");
801047b5:	83 ec 0c             	sub    $0xc,%esp
801047b8:	68 7d 7a 10 80       	push   $0x80107a7d
801047bd:	e8 ce bb ff ff       	call   80100390 <panic>
801047c2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(; i < 10; i++)
801047c8:	8d 44 83 0c          	lea    0xc(%ebx,%eax,4),%eax
801047cc:	83 c3 34             	add    $0x34,%ebx
801047cf:	90                   	nop
    pcs[i] = 0;
...
801047db:	75 f3                	jne    801047d0 <acquire+0xd0>
}
...
801047e3:	c3                   	ret    
    popcli();
801047e4:	e8 67 fe ff ff       	call   80104650 <popcli>
    return;
801047e9:	eb bc                	jmp    801047a7 <acquire+0xa7>
...
801047ff:	e8 ac fe ff ff       	call   801046b0 <holding>
80104804:	83 c4 10             	add    $0x10,%esp
80104807:	85 c0                	test   %eax,%eax
80104809:	74 29                	je     80104834 <release+0x44>
  lk->pcs[0] = 0;
8010480b:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80104812:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  lk->pid = -1;
80104819:	c7 43 34 ff ff ff ff 	movl   $0xffffffff,0x34(%ebx)
  __sync_synchronize();
80104820:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104825:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
8010482b:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010482e:	c9                   	leave  
  popcli();
8010482f:	e9 1c fe ff ff       	jmp    80104650 <popcli>
    panic("release");
80104834:	83 ec 0c             	sub    $0xc,%esp
80104837:	68 85 7a 10 80       	push   $0x80107a85
8010483c:	e8 4f bb ff ff       	call   80100390 <panic>
80104841:	66 90                	xchg   %ax,%ax
80104843:	66 90                	xchg   %ax,%ax
80104845:	66 90                	xchg   %ax,%ax
80104847:	66 90                	xchg   %ax,%ax
80104849:	66 90                	xchg   %ax,%ax
8010484b:	66 90                	xchg   %ax,%ax
8010484d:	66 90                	xchg   %ax,%ax
8010484f:	90                   	nop
...
80104c3b:	83 fa 21             	cmp    $0x21,%edx
80104c3e:	77 20                	ja     80104c60 <syscall+0x40>
80104c40:	8b 14 85 c0 7a 10 80 	mov    -0x7fef8540(,%eax,4),%edx
...
80104c68:	68 8d 7a 10 80       	push   $0x80107a8d
...
80104cf5:	66 83 7e 54 02       	cmpw   $0x2,0x54(%esi)
...
80104d59:	66 89 46 56          	mov    %ax,0x56(%esi)
  ip->minor = minor;
80104d5d:	0f b7 45 cc          	movzwl -0x34(%ebp),%eax
80104d61:	66 89 46 58          	mov    %ax,0x58(%esi)
  ip->nlink = 1;
80104d65:	b8 01 00 00 00       	mov    $0x1,%eax
80104d6a:	66 89 46 5a          	mov    %ax,0x5a(%esi)
  iupdate(ip);
...
80104db0:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80104db3:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
    iupdate(dp);
...
80104dc4:	68 68 7b 10 80       	push   $0x80107b68
...
80104ddc:	68 67 7b 10 80       	push   $0x80107b67
...
80104df1:	68 5b 7b 10 80       	push   $0x80107b5b
...
80104e0f:	68 6a 7b 10 80       	push   $0x80107b6a
80104e14:	e8 77 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104e19:	83 ec 0c             	sub    $0xc,%esp
80104e1c:	68 4c 7b 10 80       	push   $0x80107b4c
...
801050d5:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
801050da:	0f 84 b9 00 00 00    	je     80105199 <sys_link+0x129>
  iupdate(ip);
801050e0:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
801050e3:	66 83 43 5a 01       	addw   $0x1,0x5a(%ebx)
...
80105170:	e8 eb c5 ff ff       	call   80101760 <ilock>
  ip->nlink--;
80105175:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
...
8010520d:	58                   	pop    %eax
8010520e:	5a                   	pop    %edx
8010520f:	68 68 7b 10 80       	push   $0x80107b68
...
80105228:	68 67 7b 10 80       	push   $0x80107b67
...
80105265:	66 83 7b 5a 00       	cmpw   $0x0,0x5a(%ebx)
8010526a:	0f 8e 23 01 00 00    	jle    80105393 <sys_unlink+0x1d3>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105270:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80105299:	0f 85 e7 00 00 00    	jne    80105386 <sys_unlink+0x1c6>
  if(ip->type == T_DIR){
8010529f:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
801052ae:	e8 4d c7 ff ff       	call   80101a00 <iunlockput>
  ip->nlink--;
801052b3:	66 83 6b 5a 01       	subw   $0x1,0x5a(%ebx)
  iupdate(ip);
...
801052e0:	83 7b 5c 20          	cmpl   $0x20,0x5c(%ebx)
...
801052f3:	39 53 5c             	cmp    %edx,0x5c(%ebx)
...
80105340:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink--;
80105343:	66 83 6e 5a 01       	subw   $0x1,0x5a(%esi)
    iupdate(dp);
...
80105403:	66 83 7e 54 01       	cmpw   $0x1,0x54(%esi)
...
8010563d:	66 83 7b 54 01       	cmpw   $0x1,0x54(%ebx)
...
80105994:	68 40 4f 11 80       	push   $0x80114f40
80105999:	e8 62 ed ff ff       	call   80104700 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010599e:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801059a1:	8b 1d 80 57 11 80    	mov    0x80115780,%ebx
  while(ticks - ticks0 < n){
...
801059b3:	68 40 4f 11 80       	push   $0x80114f40
801059b8:	68 80 57 11 80       	push   $0x80115780
801059bd:	e8 5e e5 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
801059c2:	a1 80 57 11 80       	mov    0x80115780,%eax
...
801059e0:	68 40 4f 11 80       	push   $0x80114f40
801059e5:	e8 06 ee ff ff       	call   801047f0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105a03:	68 40 4f 11 80       	push   $0x80114f40
80105a08:	e8 e3 ed ff ff       	call   801047f0 <release>
  return 0;
...
80105a28:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105a2b:	68 40 4f 11 80       	push   $0x80114f40
80105a30:	e8 cb ec ff ff       	call   80104700 <acquire>
  xticks = ticks;
80105a35:	8b 1d 80 57 11 80    	mov    0x80115780,%ebx
  release(&tickslock);
80105a3b:	c7 04 24 40 4f 11 80 	movl   $0x80114f40,(%esp)
80105a42:	e8 a9 ed ff ff       	call   801047f0 <release>
  return xticks;
}
...
80105a6a:	78 2c                	js     80105a98 <sys_sem_init+0x48>
    return -1;
  if (argint(1, &k) < 0)
80105a6c:	83 ec 08             	sub    $0x8,%esp
80105a6f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105a72:	50                   	push   %eax
80105a73:	6a 01                	push   $0x1
80105a75:	e8 b6 f0 ff ff       	call   80104b30 <argint>
80105a7a:	83 c4 10             	add    $0x10,%esp
80105a7d:	85 c0                	test   %eax,%eax
80105a7f:	78 17                	js     80105a98 <sys_sem_init+0x48>
    return -1;
...
80105a8a:	e8 11 e8 ff ff       	call   801042a0 <sem_init>
...
80105aa7:	83 ec 20             	sub    $0x20,%esp
  int i;
...
80105ab0:	e8 7b f0 ff ff       	call   80104b30 <argint>
80105ab5:	83 c4 10             	add    $0x10,%esp
80105ab8:	85 c0                	test   %eax,%eax
80105aba:	78 14                	js     80105ad0 <sys_sem_acquire+0x30>
    return -1;

  return sem_acquire(i);
80105abc:	83 ec 0c             	sub    $0xc,%esp
80105abf:	ff 75 f4             	pushl  -0xc(%ebp)
80105ac2:	e8 39 e8 ff ff       	call   80104300 <sem_acquire>
...
80105afa:	78 14                	js     80105b10 <sys_sem_release+0x30>
    return -1;

  return sem_release(i);
80105afc:	83 ec 0c             	sub    $0xc,%esp
80105aff:	ff 75 f4             	pushl  -0xc(%ebp)
80105b02:	e8 79 e8 ff ff       	call   80104380 <sem_release>
...
80105b27:	83 ec 20             	sub    $0x20,%esp
  int count;
...
80105b30:	e8 fb ef ff ff       	call   80104b30 <argint>
80105b35:	83 c4 10             	add    $0x10,%esp
80105b38:	85 c0                	test   %eax,%eax
80105b3a:	78 0e                	js     80105b4a <sys_reentrant+0x2a>
    return;

  reentrant(count);
80105b3c:	83 ec 0c             	sub    $0xc,%esp
80105b3f:	ff 75 f4             	pushl  -0xc(%ebp)
80105b42:	e8 89 e8 ff ff       	call   801043d0 <reentrant>
...
80105b87:	c7 04 c5 82 4f 11 80 	movl   $0x8e000008,-0x7feeb07e(,%eax,8)
80105b8e:	08 00 00 8e 
80105b92:	66 89 14 c5 80 4f 11 	mov    %dx,-0x7feeb080(,%eax,8)
80105b99:	80 
80105b9a:	c1 ea 10             	shr    $0x10,%edx
80105b9d:	66 89 14 c5 86 4f 11 	mov    %dx,-0x7feeb07a(,%eax,8)
80105ba4:	80 
  for(i = 0; i < 256; i++)
...
80105bb7:	c7 05 82 51 11 80 08 	movl   $0xef000008,0x80115182
80105bbe:	00 00 ef 
  initlock(&tickslock, "time");
80105bc1:	68 ad 7b 10 80       	push   $0x80107bad
80105bc6:	68 40 4f 11 80       	push   $0x80114f40
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105bcb:	66 a3 80 51 11 80    	mov    %ax,0x80115180
80105bd1:	c1 e8 10             	shr    $0x10,%eax
80105bd4:	66 a3 86 51 11 80    	mov    %ax,0x80115186
  initlock(&tickslock, "time");
80105bda:	e8 91 e9 ff ff       	call   80104570 <initlock>
}
...
80105bf4:	55                   	push   %ebp
  pd[0] = size-1;
80105bf5:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105bfa:	89 e5                	mov    %esp,%ebp
80105bfc:	83 ec 10             	sub    $0x10,%esp
80105bff:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c03:	b8 80 4f 11 80       	mov    $0x80114f80,%eax
80105c08:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105c0c:	c1 e8 10             	shr    $0x10,%eax
80105c0f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105c13:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105c16:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105c19:	c9                   	leave  
80105c1a:	c3                   	ret    
...
80105c2a:	83 ec 1c             	sub    $0x1c,%esp
80105c2d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105c30:	8b 43 30             	mov    0x30(%ebx),%eax
80105c33:	83 f8 40             	cmp    $0x40,%eax
80105c36:	0f 84 bc 01 00 00    	je     80105df8 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105c3c:	83 e8 20             	sub    $0x20,%eax
80105c3f:	83 f8 1f             	cmp    $0x1f,%eax
80105c42:	77 08                	ja     80105c4c <trap+0x2c>
80105c44:	3e ff 24 85 54 7c 10 	notrack jmp *-0x7fef83ac(,%eax,4)
80105c4b:	80 
    lapiceoi();
    break;
...
80105c4c:	e8 0f dd ff ff       	call   80103960 <myproc>
80105c51:	8b 7b 38             	mov    0x38(%ebx),%edi
80105c54:	85 c0                	test   %eax,%eax
80105c56:	0f 84 eb 01 00 00    	je     80105e47 <trap+0x227>
80105c5c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105c60:	0f 84 e1 01 00 00    	je     80105e47 <trap+0x227>
...
80105c66:	0f 20 d1             	mov    %cr2,%ecx
80105c69:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105c6c:	e8 cf dc ff ff       	call   80103940 <cpuid>
80105c71:	8b 73 30             	mov    0x30(%ebx),%esi
80105c74:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105c77:	8b 43 34             	mov    0x34(%ebx),%eax
80105c7a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105c7d:	e8 de dc ff ff       	call   80103960 <myproc>
80105c82:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105c85:	e8 d6 dc ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c8a:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105c8d:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105c90:	51                   	push   %ecx
80105c91:	57                   	push   %edi
80105c92:	52                   	push   %edx
80105c93:	ff 75 e4             	pushl  -0x1c(%ebp)
80105c96:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105c97:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105c9a:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105c9d:	56                   	push   %esi
80105c9e:	ff 70 10             	pushl  0x10(%eax)
80105ca1:	68 10 7c 10 80       	push   $0x80107c10
80105ca6:	e8 05 aa ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105cab:	83 c4 20             	add    $0x20,%esp
80105cae:	e8 ad dc ff ff       	call   80103960 <myproc>
...
80105d25:	c3                   	ret    
    ideintr();
80105d26:	e8 b5 c4 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105d2b:	e8 90 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d30:	e8 2b dc ff ff       	call   80103960 <myproc>
80105d35:	85 c0                	test   %eax,%eax
80105d37:	75 8a                	jne    80105cc3 <trap+0xa3>
80105d39:	eb a5                	jmp    80105ce0 <trap+0xc0>
    if(cpuid() == 0){
80105d3b:	e8 00 dc ff ff       	call   80103940 <cpuid>
80105d40:	85 c0                	test   %eax,%eax
80105d42:	75 e7                	jne    80105d2b <trap+0x10b>
      acquire(&tickslock);
80105d44:	83 ec 0c             	sub    $0xc,%esp
80105d47:	68 40 4f 11 80       	push   $0x80114f40
80105d4c:	e8 af e9 ff ff       	call   80104700 <acquire>
      wakeup(&ticks);
80105d51:	c7 04 24 80 57 11 80 	movl   $0x80115780,(%esp)
      ticks++;
80105d58:	83 05 80 57 11 80 01 	addl   $0x1,0x80115780
      wakeup(&ticks);
80105d5f:	e8 7c e3 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105d64:	c7 04 24 40 4f 11 80 	movl   $0x80114f40,(%esp)
80105d6b:	e8 80 ea ff ff       	call   801047f0 <release>
80105d70:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105d73:	eb b6                	jmp    80105d2b <trap+0x10b>
    kbdintr();
80105d75:	e8 06 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105d7a:	e8 41 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d7f:	e8 dc db ff ff       	call   80103960 <myproc>
80105d84:	85 c0                	test   %eax,%eax
80105d86:	0f 85 37 ff ff ff    	jne    80105cc3 <trap+0xa3>
80105d8c:	e9 4f ff ff ff       	jmp    80105ce0 <trap+0xc0>
    uartintr();
80105d91:	e8 4a 02 00 00       	call   80105fe0 <uartintr>
    lapiceoi();
80105d96:	e8 25 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105d9b:	e8 c0 db ff ff       	call   80103960 <myproc>
80105da0:	85 c0                	test   %eax,%eax
80105da2:	0f 85 1b ff ff ff    	jne    80105cc3 <trap+0xa3>
80105da8:	e9 33 ff ff ff       	jmp    80105ce0 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105dad:	8b 7b 38             	mov    0x38(%ebx),%edi
80105db0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105db4:	e8 87 db ff ff       	call   80103940 <cpuid>
80105db9:	57                   	push   %edi
80105dba:	56                   	push   %esi
80105dbb:	50                   	push   %eax
80105dbc:	68 b8 7b 10 80       	push   $0x80107bb8
80105dc1:	e8 ea a8 ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105dc6:	e8 f5 ca ff ff       	call   801028c0 <lapiceoi>
    break;
80105dcb:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105dce:	e8 8d db ff ff       	call   80103960 <myproc>
80105dd3:	85 c0                	test   %eax,%eax
80105dd5:	0f 85 e8 fe ff ff    	jne    80105cc3 <trap+0xa3>
80105ddb:	e9 00 ff ff ff       	jmp    80105ce0 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105de0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105de4:	0f 85 0e ff ff ff    	jne    80105cf8 <trap+0xd8>
    yield();
80105dea:	e8 e1 e0 ff ff       	call   80103ed0 <yield>
80105def:	e9 04 ff ff ff       	jmp    80105cf8 <trap+0xd8>
80105df4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105df8:	e8 63 db ff ff       	call   80103960 <myproc>
80105dfd:	8b 70 24             	mov    0x24(%eax),%esi
80105e00:	85 f6                	test   %esi,%esi
80105e02:	75 3c                	jne    80105e40 <trap+0x220>
    myproc()->tf = tf;
80105e04:	e8 57 db ff ff       	call   80103960 <myproc>
80105e09:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105e0c:	e8 0f ee ff ff       	call   80104c20 <syscall>
    if(myproc()->killed)
80105e11:	e8 4a db ff ff       	call   80103960 <myproc>
80105e16:	8b 48 24             	mov    0x24(%eax),%ecx
80105e19:	85 c9                	test   %ecx,%ecx
80105e1b:	0f 84 fd fe ff ff    	je     80105d1e <trap+0xfe>
}
...
80105e27:	5d                   	pop    %ebp
      exit();
80105e28:	e9 63 df ff ff       	jmp    80103d90 <exit>
80105e2d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105e30:	e8 5b df ff ff       	call   80103d90 <exit>
80105e35:	e9 a6 fe ff ff       	jmp    80105ce0 <trap+0xc0>
80105e3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105e40:	e8 4b df ff ff       	call   80103d90 <exit>
80105e45:	eb bd                	jmp    80105e04 <trap+0x1e4>
80105e47:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105e4a:	e8 f1 da ff ff       	call   80103940 <cpuid>
80105e4f:	83 ec 0c             	sub    $0xc,%esp
80105e52:	56                   	push   %esi
80105e53:	57                   	push   %edi
80105e54:	50                   	push   %eax
80105e55:	ff 73 30             	pushl  0x30(%ebx)
80105e58:	68 dc 7b 10 80       	push   $0x80107bdc
80105e5d:	e8 4e a8 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105e62:	83 c4 14             	add    $0x14,%esp
80105e65:	68 b2 7b 10 80       	push   $0x80107bb2
...
80105e70:	f3 0f 1e fb          	endbr32 
  if(!uart)
80105e74:	a1 c0 a5 10 80       	mov    0x8010a5c0,%eax
80105e79:	85 c0                	test   %eax,%eax
80105e7b:	74 1b                	je     80105e98 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105e7d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105e82:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105e83:	a8 01                	test   $0x1,%al
80105e85:	74 11                	je     80105e98 <uartgetc+0x28>
...
80105ea4:	89 c7                	mov    %eax,%edi
80105ea6:	56                   	push   %esi
80105ea7:	be fd 03 00 00       	mov    $0x3fd,%esi
80105eac:	53                   	push   %ebx
80105ead:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80105ec5:	e8 16 ca ff ff       	call   801028e0 <microdelay>
...
80105ef5:	31 c9                	xor    %ecx,%ecx
80105ef7:	89 c8                	mov    %ecx,%eax
80105ef9:	89 e5                	mov    %esp,%ebp
80105efb:	57                   	push   %edi
80105efc:	56                   	push   %esi
80105efd:	53                   	push   %ebx
80105efe:	bb fa 03 00 00       	mov    $0x3fa,%ebx
80105f03:	89 da                	mov    %ebx,%edx
80105f05:	83 ec 0c             	sub    $0xc,%esp
80105f08:	ee                   	out    %al,(%dx)
80105f09:	bf fb 03 00 00       	mov    $0x3fb,%edi
80105f0e:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
80105f13:	89 fa                	mov    %edi,%edx
80105f15:	ee                   	out    %al,(%dx)
80105f16:	b8 0c 00 00 00       	mov    $0xc,%eax
80105f1b:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105f20:	ee                   	out    %al,(%dx)
80105f21:	be f9 03 00 00       	mov    $0x3f9,%esi
80105f26:	89 c8                	mov    %ecx,%eax
80105f28:	89 f2                	mov    %esi,%edx
80105f2a:	ee                   	out    %al,(%dx)
80105f2b:	b8 03 00 00 00       	mov    $0x3,%eax
80105f30:	89 fa                	mov    %edi,%edx
80105f32:	ee                   	out    %al,(%dx)
80105f33:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105f38:	89 c8                	mov    %ecx,%eax
80105f3a:	ee                   	out    %al,(%dx)
80105f3b:	b8 01 00 00 00       	mov    $0x1,%eax
80105f40:	89 f2                	mov    %esi,%edx
80105f42:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105f43:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105f48:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105f49:	3c ff                	cmp    $0xff,%al
80105f4b:	74 52                	je     80105f9f <uartinit+0xaf>
  uart = 1;
80105f4d:	c7 05 c0 a5 10 80 01 	movl   $0x1,0x8010a5c0
80105f54:	00 00 00 
80105f57:	89 da                	mov    %ebx,%edx
80105f59:	ec                   	in     (%dx),%al
80105f5a:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105f5f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105f60:	83 ec 08             	sub    $0x8,%esp
80105f63:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105f68:	bb d4 7c 10 80       	mov    $0x80107cd4,%ebx
  ioapicenable(IRQ_COM1, 0);
80105f6d:	6a 00                	push   $0x0
80105f6f:	6a 04                	push   $0x4
80105f71:	e8 ba c4 ff ff       	call   80102430 <ioapicenable>
80105f76:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105f79:	b8 78 00 00 00       	mov    $0x78,%eax
80105f7e:	eb 04                	jmp    80105f84 <uartinit+0x94>
80105f80:	0f b6 73 01          	movzbl 0x1(%ebx),%esi
  if(!uart)
80105f84:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
80105f8a:	85 d2                	test   %edx,%edx
80105f8c:	74 08                	je     80105f96 <uartinit+0xa6>
    uartputc(*p);
80105f8e:	0f be c0             	movsbl %al,%eax
80105f91:	e8 0a ff ff ff       	call   80105ea0 <uartputc.part.0>
  for(p="xv6...\n"; *p; p++)
80105f96:	89 f0                	mov    %esi,%eax
80105f98:	83 c3 01             	add    $0x1,%ebx
80105f9b:	84 c0                	test   %al,%al
80105f9d:	75 e1                	jne    80105f80 <uartinit+0x90>
}
...
80105fb4:	55                   	push   %ebp
  if(!uart)
80105fb5:	8b 15 c0 a5 10 80    	mov    0x8010a5c0,%edx
{
80105fbb:	89 e5                	mov    %esp,%ebp
80105fbd:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
80105fc0:	85 d2                	test   %edx,%edx
80105fc2:	74 0c                	je     80105fd0 <uartputc+0x20>
}
80105fc4:	5d                   	pop    %ebp
80105fc5:	e9 d6 fe ff ff       	jmp    80105ea0 <uartputc.part.0>
...
80105fe7:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80105fea:	68 70 5e 10 80       	push   $0x80105e70
80105fef:	e8 6c a8 ff ff       	call   80100860 <consoleintr>
}
...
80105ffb:	6a 00                	push   $0x0
  jmp alltraps
80105ffd:	e9 4a fb ff ff       	jmp    80105b4c <alltraps>
...
80106004:	6a 01                	push   $0x1
  jmp alltraps
80106006:	e9 41 fb ff ff       	jmp    80105b4c <alltraps>
...
8010600d:	6a 02                	push   $0x2
  jmp alltraps
8010600f:	e9 38 fb ff ff       	jmp    80105b4c <alltraps>
...
80106014:	6a 00                	push   $0x0
  pushl $3
80106016:	6a 03                	push   $0x3
  jmp alltraps
80106018:	e9 2f fb ff ff       	jmp    80105b4c <alltraps>
...
8010601f:	6a 04                	push   $0x4
  jmp alltraps
80106021:	e9 26 fb ff ff       	jmp    80105b4c <alltraps>
...
80106026:	6a 00                	push   $0x0
  pushl $5
80106028:	6a 05                	push   $0x5
  jmp alltraps
8010602a:	e9 1d fb ff ff       	jmp    80105b4c <alltraps>
...
8010602f:	6a 00                	push   $0x0
  pushl $6
80106031:	6a 06                	push   $0x6
  jmp alltraps
80106033:	e9 14 fb ff ff       	jmp    80105b4c <alltraps>
...
80106038:	6a 00                	push   $0x0
  pushl $7
8010603a:	6a 07                	push   $0x7
  jmp alltraps
8010603c:	e9 0b fb ff ff       	jmp    80105b4c <alltraps>

80106041 <vector8>:
.globl vector8
vector8:
  pushl $8
80106041:	6a 08                	push   $0x8
  jmp alltraps
80106043:	e9 04 fb ff ff       	jmp    80105b4c <alltraps>
...
80106048:	6a 00                	push   $0x0
  pushl $9
8010604a:	6a 09                	push   $0x9
  jmp alltraps
8010604c:	e9 fb fa ff ff       	jmp    80105b4c <alltraps>

80106051 <vector10>:
.globl vector10
vector10:
  pushl $10
80106051:	6a 0a                	push   $0xa
  jmp alltraps
80106053:	e9 f4 fa ff ff       	jmp    80105b4c <alltraps>

80106058 <vector11>:
.globl vector11
vector11:
  pushl $11
80106058:	6a 0b                	push   $0xb
  jmp alltraps
8010605a:	e9 ed fa ff ff       	jmp    80105b4c <alltraps>

8010605f <vector12>:
.globl vector12
vector12:
  pushl $12
8010605f:	6a 0c                	push   $0xc
  jmp alltraps
80106061:	e9 e6 fa ff ff       	jmp    80105b4c <alltraps>

80106066 <vector13>:
.globl vector13
vector13:
  pushl $13
80106066:	6a 0d                	push   $0xd
  jmp alltraps
80106068:	e9 df fa ff ff       	jmp    80105b4c <alltraps>

8010606d <vector14>:
.globl vector14
vector14:
  pushl $14
8010606d:	6a 0e                	push   $0xe
  jmp alltraps
...
8010607f:	6a 10                	push   $0x10
  jmp alltraps
80106081:	e9 c6 fa ff ff       	jmp    80105b4c <alltraps>

80106086 <vector17>:
.globl vector17
vector17:
  pushl $17
80106086:	6a 11                	push   $0x11
  jmp alltraps
...
8010608d:	6a 00                	push   $0x0
  pushl $18
8010608f:	6a 12                	push   $0x12
  jmp alltraps
80106091:	e9 b6 fa ff ff       	jmp    80105b4c <alltraps>
...
80106096:	6a 00                	push   $0x0
  pushl $19
80106098:	6a 13                	push   $0x13
  jmp alltraps
8010609a:	e9 ad fa ff ff       	jmp    80105b4c <alltraps>
...
8010609f:	6a 00                	push   $0x0
  pushl $20
801060a1:	6a 14                	push   $0x14
  jmp alltraps
801060a3:	e9 a4 fa ff ff       	jmp    80105b4c <alltraps>
...
801060a8:	6a 00                	push   $0x0
  pushl $21
801060aa:	6a 15                	push   $0x15
  jmp alltraps
801060ac:	e9 9b fa ff ff       	jmp    80105b4c <alltraps>
...
801060b1:	6a 00                	push   $0x0
  pushl $22
801060b3:	6a 16                	push   $0x16
  jmp alltraps
801060b5:	e9 92 fa ff ff       	jmp    80105b4c <alltraps>
...
801060ba:	6a 00                	push   $0x0
  pushl $23
801060bc:	6a 17                	push   $0x17
  jmp alltraps
801060be:	e9 89 fa ff ff       	jmp    80105b4c <alltraps>
...
801060c3:	6a 00                	push   $0x0
  pushl $24
801060c5:	6a 18                	push   $0x18
  jmp alltraps
801060c7:	e9 80 fa ff ff       	jmp    80105b4c <alltraps>
...
801060cc:	6a 00                	push   $0x0
  pushl $25
801060ce:	6a 19                	push   $0x19
  jmp alltraps
801060d0:	e9 77 fa ff ff       	jmp    80105b4c <alltraps>
...
801060d5:	6a 00                	push   $0x0
  pushl $26
801060d7:	6a 1a                	push   $0x1a
  jmp alltraps
801060d9:	e9 6e fa ff ff       	jmp    80105b4c <alltraps>
...
801060de:	6a 00                	push   $0x0
  pushl $27
801060e0:	6a 1b                	push   $0x1b
  jmp alltraps
801060e2:	e9 65 fa ff ff       	jmp    80105b4c <alltraps>
...
801060e7:	6a 00                	push   $0x0
  pushl $28
801060e9:	6a 1c                	push   $0x1c
  jmp alltraps
801060eb:	e9 5c fa ff ff       	jmp    80105b4c <alltraps>
...
801060f0:	6a 00                	push   $0x0
  pushl $29
801060f2:	6a 1d                	push   $0x1d
  jmp alltraps
801060f4:	e9 53 fa ff ff       	jmp    80105b4c <alltraps>
...
801060f9:	6a 00                	push   $0x0
  pushl $30
801060fb:	6a 1e                	push   $0x1e
  jmp alltraps
801060fd:	e9 4a fa ff ff       	jmp    80105b4c <alltraps>
...
80106102:	6a 00                	push   $0x0
  pushl $31
80106104:	6a 1f                	push   $0x1f
  jmp alltraps
80106106:	e9 41 fa ff ff       	jmp    80105b4c <alltraps>
...
8010610d:	6a 20                	push   $0x20
  jmp alltraps
8010610f:	e9 38 fa ff ff       	jmp    80105b4c <alltraps>
...
80106114:	6a 00                	push   $0x0
  pushl $33
80106116:	6a 21                	push   $0x21
  jmp alltraps
80106118:	e9 2f fa ff ff       	jmp    80105b4c <alltraps>
...
8010611d:	6a 00                	push   $0x0
  pushl $34
8010611f:	6a 22                	push   $0x22
  jmp alltraps
80106121:	e9 26 fa ff ff       	jmp    80105b4c <alltraps>
...
80106126:	6a 00                	push   $0x0
  pushl $35
80106128:	6a 23                	push   $0x23
  jmp alltraps
8010612a:	e9 1d fa ff ff       	jmp    80105b4c <alltraps>
...
8010612f:	6a 00                	push   $0x0
  pushl $36
80106131:	6a 24                	push   $0x24
  jmp alltraps
80106133:	e9 14 fa ff ff       	jmp    80105b4c <alltraps>
...
80106138:	6a 00                	push   $0x0
  pushl $37
8010613a:	6a 25                	push   $0x25
  jmp alltraps
8010613c:	e9 0b fa ff ff       	jmp    80105b4c <alltraps>
...
80106141:	6a 00                	push   $0x0
  pushl $38
80106143:	6a 26                	push   $0x26
  jmp alltraps
80106145:	e9 02 fa ff ff       	jmp    80105b4c <alltraps>
...
8010614a:	6a 00                	push   $0x0
  pushl $39
8010614c:	6a 27                	push   $0x27
  jmp alltraps
8010614e:	e9 f9 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106153:	6a 00                	push   $0x0
  pushl $40
80106155:	6a 28                	push   $0x28
  jmp alltraps
80106157:	e9 f0 f9 ff ff       	jmp    80105b4c <alltraps>
...
8010615c:	6a 00                	push   $0x0
  pushl $41
8010615e:	6a 29                	push   $0x29
  jmp alltraps
80106160:	e9 e7 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106165:	6a 00                	push   $0x0
  pushl $42
80106167:	6a 2a                	push   $0x2a
  jmp alltraps
80106169:	e9 de f9 ff ff       	jmp    80105b4c <alltraps>
...
8010616e:	6a 00                	push   $0x0
  pushl $43
80106170:	6a 2b                	push   $0x2b
  jmp alltraps
80106172:	e9 d5 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106177:	6a 00                	push   $0x0
  pushl $44
80106179:	6a 2c                	push   $0x2c
  jmp alltraps
8010617b:	e9 cc f9 ff ff       	jmp    80105b4c <alltraps>
...
80106180:	6a 00                	push   $0x0
  pushl $45
80106182:	6a 2d                	push   $0x2d
  jmp alltraps
80106184:	e9 c3 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106189:	6a 00                	push   $0x0
  pushl $46
8010618b:	6a 2e                	push   $0x2e
  jmp alltraps
8010618d:	e9 ba f9 ff ff       	jmp    80105b4c <alltraps>
...
80106192:	6a 00                	push   $0x0
  pushl $47
80106194:	6a 2f                	push   $0x2f
  jmp alltraps
80106196:	e9 b1 f9 ff ff       	jmp    80105b4c <alltraps>
...
8010619b:	6a 00                	push   $0x0
  pushl $48
8010619d:	6a 30                	push   $0x30
  jmp alltraps
8010619f:	e9 a8 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061a4:	6a 00                	push   $0x0
  pushl $49
801061a6:	6a 31                	push   $0x31
  jmp alltraps
801061a8:	e9 9f f9 ff ff       	jmp    80105b4c <alltraps>
...
801061ad:	6a 00                	push   $0x0
  pushl $50
801061af:	6a 32                	push   $0x32
  jmp alltraps
801061b1:	e9 96 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061b6:	6a 00                	push   $0x0
  pushl $51
801061b8:	6a 33                	push   $0x33
  jmp alltraps
801061ba:	e9 8d f9 ff ff       	jmp    80105b4c <alltraps>
...
801061bf:	6a 00                	push   $0x0
  pushl $52
801061c1:	6a 34                	push   $0x34
  jmp alltraps
801061c3:	e9 84 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061c8:	6a 00                	push   $0x0
  pushl $53
801061ca:	6a 35                	push   $0x35
  jmp alltraps
801061cc:	e9 7b f9 ff ff       	jmp    80105b4c <alltraps>
...
801061d1:	6a 00                	push   $0x0
  pushl $54
801061d3:	6a 36                	push   $0x36
  jmp alltraps
801061d5:	e9 72 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061da:	6a 00                	push   $0x0
  pushl $55
801061dc:	6a 37                	push   $0x37
  jmp alltraps
801061de:	e9 69 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061e3:	6a 00                	push   $0x0
  pushl $56
801061e5:	6a 38                	push   $0x38
  jmp alltraps
801061e7:	e9 60 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061ec:	6a 00                	push   $0x0
  pushl $57
801061ee:	6a 39                	push   $0x39
  jmp alltraps
801061f0:	e9 57 f9 ff ff       	jmp    80105b4c <alltraps>
...
801061f5:	6a 00                	push   $0x0
  pushl $58
801061f7:	6a 3a                	push   $0x3a
  jmp alltraps
801061f9:	e9 4e f9 ff ff       	jmp    80105b4c <alltraps>
...
801061fe:	6a 00                	push   $0x0
  pushl $59
80106200:	6a 3b                	push   $0x3b
  jmp alltraps
80106202:	e9 45 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106207:	6a 00                	push   $0x0
  pushl $60
80106209:	6a 3c                	push   $0x3c
  jmp alltraps
8010620b:	e9 3c f9 ff ff       	jmp    80105b4c <alltraps>
...
80106210:	6a 00                	push   $0x0
  pushl $61
80106212:	6a 3d                	push   $0x3d
  jmp alltraps
80106214:	e9 33 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106219:	6a 00                	push   $0x0
  pushl $62
8010621b:	6a 3e                	push   $0x3e
  jmp alltraps
8010621d:	e9 2a f9 ff ff       	jmp    80105b4c <alltraps>
...
80106222:	6a 00                	push   $0x0
  pushl $63
80106224:	6a 3f                	push   $0x3f
  jmp alltraps
80106226:	e9 21 f9 ff ff       	jmp    80105b4c <alltraps>
...
8010622b:	6a 00                	push   $0x0
  pushl $64
8010622d:	6a 40                	push   $0x40
  jmp alltraps
8010622f:	e9 18 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106234:	6a 00                	push   $0x0
  pushl $65
80106236:	6a 41                	push   $0x41
  jmp alltraps
80106238:	e9 0f f9 ff ff       	jmp    80105b4c <alltraps>
...
8010623d:	6a 00                	push   $0x0
  pushl $66
8010623f:	6a 42                	push   $0x42
  jmp alltraps
80106241:	e9 06 f9 ff ff       	jmp    80105b4c <alltraps>
...
80106246:	6a 00                	push   $0x0
  pushl $67
80106248:	6a 43                	push   $0x43
  jmp alltraps
8010624a:	e9 fd f8 ff ff       	jmp    80105b4c <alltraps>
...
8010624f:	6a 00                	push   $0x0
  pushl $68
80106251:	6a 44                	push   $0x44
  jmp alltraps
80106253:	e9 f4 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106258:	6a 00                	push   $0x0
  pushl $69
8010625a:	6a 45                	push   $0x45
  jmp alltraps
8010625c:	e9 eb f8 ff ff       	jmp    80105b4c <alltraps>
...
80106261:	6a 00                	push   $0x0
  pushl $70
80106263:	6a 46                	push   $0x46
  jmp alltraps
80106265:	e9 e2 f8 ff ff       	jmp    80105b4c <alltraps>
...
8010626a:	6a 00                	push   $0x0
  pushl $71
8010626c:	6a 47                	push   $0x47
  jmp alltraps
8010626e:	e9 d9 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106273:	6a 00                	push   $0x0
  pushl $72
80106275:	6a 48                	push   $0x48
  jmp alltraps
80106277:	e9 d0 f8 ff ff       	jmp    80105b4c <alltraps>
...
8010627c:	6a 00                	push   $0x0
  pushl $73
8010627e:	6a 49                	push   $0x49
  jmp alltraps
80106280:	e9 c7 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106285:	6a 00                	push   $0x0
  pushl $74
80106287:	6a 4a                	push   $0x4a
  jmp alltraps
80106289:	e9 be f8 ff ff       	jmp    80105b4c <alltraps>
...
8010628e:	6a 00                	push   $0x0
  pushl $75
80106290:	6a 4b                	push   $0x4b
  jmp alltraps
80106292:	e9 b5 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106297:	6a 00                	push   $0x0
  pushl $76
80106299:	6a 4c                	push   $0x4c
  jmp alltraps
8010629b:	e9 ac f8 ff ff       	jmp    80105b4c <alltraps>
...
801062a0:	6a 00                	push   $0x0
  pushl $77
801062a2:	6a 4d                	push   $0x4d
  jmp alltraps
801062a4:	e9 a3 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062a9:	6a 00                	push   $0x0
  pushl $78
801062ab:	6a 4e                	push   $0x4e
  jmp alltraps
801062ad:	e9 9a f8 ff ff       	jmp    80105b4c <alltraps>
...
801062b2:	6a 00                	push   $0x0
  pushl $79
801062b4:	6a 4f                	push   $0x4f
  jmp alltraps
801062b6:	e9 91 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062bb:	6a 00                	push   $0x0
  pushl $80
801062bd:	6a 50                	push   $0x50
  jmp alltraps
801062bf:	e9 88 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062c4:	6a 00                	push   $0x0
  pushl $81
801062c6:	6a 51                	push   $0x51
  jmp alltraps
801062c8:	e9 7f f8 ff ff       	jmp    80105b4c <alltraps>
...
801062cd:	6a 00                	push   $0x0
  pushl $82
801062cf:	6a 52                	push   $0x52
  jmp alltraps
801062d1:	e9 76 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062d6:	6a 00                	push   $0x0
  pushl $83
801062d8:	6a 53                	push   $0x53
  jmp alltraps
801062da:	e9 6d f8 ff ff       	jmp    80105b4c <alltraps>
...
801062df:	6a 00                	push   $0x0
  pushl $84
801062e1:	6a 54                	push   $0x54
  jmp alltraps
801062e3:	e9 64 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062e8:	6a 00                	push   $0x0
  pushl $85
801062ea:	6a 55                	push   $0x55
  jmp alltraps
801062ec:	e9 5b f8 ff ff       	jmp    80105b4c <alltraps>
...
801062f1:	6a 00                	push   $0x0
  pushl $86
801062f3:	6a 56                	push   $0x56
  jmp alltraps
801062f5:	e9 52 f8 ff ff       	jmp    80105b4c <alltraps>
...
801062fa:	6a 00                	push   $0x0
  pushl $87
801062fc:	6a 57                	push   $0x57
  jmp alltraps
801062fe:	e9 49 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106303:	6a 00                	push   $0x0
  pushl $88
80106305:	6a 58                	push   $0x58
  jmp alltraps
80106307:	e9 40 f8 ff ff       	jmp    80105b4c <alltraps>
...
8010630c:	6a 00                	push   $0x0
  pushl $89
8010630e:	6a 59                	push   $0x59
  jmp alltraps
80106310:	e9 37 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106315:	6a 00                	push   $0x0
  pushl $90
80106317:	6a 5a                	push   $0x5a
  jmp alltraps
80106319:	e9 2e f8 ff ff       	jmp    80105b4c <alltraps>
...
8010631e:	6a 00                	push   $0x0
  pushl $91
80106320:	6a 5b                	push   $0x5b
  jmp alltraps
80106322:	e9 25 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106327:	6a 00                	push   $0x0
  pushl $92
80106329:	6a 5c                	push   $0x5c
  jmp alltraps
8010632b:	e9 1c f8 ff ff       	jmp    80105b4c <alltraps>
...
80106330:	6a 00                	push   $0x0
  pushl $93
80106332:	6a 5d                	push   $0x5d
  jmp alltraps
80106334:	e9 13 f8 ff ff       	jmp    80105b4c <alltraps>
...
80106339:	6a 00                	push   $0x0
  pushl $94
8010633b:	6a 5e                	push   $0x5e
  jmp alltraps
8010633d:	e9 0a f8 ff ff       	jmp    80105b4c <alltraps>
...
80106342:	6a 00                	push   $0x0
  pushl $95
80106344:	6a 5f                	push   $0x5f
  jmp alltraps
80106346:	e9 01 f8 ff ff       	jmp    80105b4c <alltraps>
...
8010634b:	6a 00                	push   $0x0
  pushl $96
8010634d:	6a 60                	push   $0x60
  jmp alltraps
8010634f:	e9 f8 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106354:	6a 00                	push   $0x0
  pushl $97
80106356:	6a 61                	push   $0x61
  jmp alltraps
80106358:	e9 ef f7 ff ff       	jmp    80105b4c <alltraps>
...
8010635d:	6a 00                	push   $0x0
  pushl $98
8010635f:	6a 62                	push   $0x62
  jmp alltraps
80106361:	e9 e6 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106366:	6a 00                	push   $0x0
  pushl $99
80106368:	6a 63                	push   $0x63
  jmp alltraps
8010636a:	e9 dd f7 ff ff       	jmp    80105b4c <alltraps>
...
8010636f:	6a 00                	push   $0x0
  pushl $100
80106371:	6a 64                	push   $0x64
  jmp alltraps
80106373:	e9 d4 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106378:	6a 00                	push   $0x0
  pushl $101
8010637a:	6a 65                	push   $0x65
  jmp alltraps
8010637c:	e9 cb f7 ff ff       	jmp    80105b4c <alltraps>
...
80106381:	6a 00                	push   $0x0
  pushl $102
80106383:	6a 66                	push   $0x66
  jmp alltraps
80106385:	e9 c2 f7 ff ff       	jmp    80105b4c <alltraps>
...
8010638a:	6a 00                	push   $0x0
  pushl $103
8010638c:	6a 67                	push   $0x67
  jmp alltraps
8010638e:	e9 b9 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106393:	6a 00                	push   $0x0
  pushl $104
80106395:	6a 68                	push   $0x68
  jmp alltraps
80106397:	e9 b0 f7 ff ff       	jmp    80105b4c <alltraps>
...
8010639c:	6a 00                	push   $0x0
  pushl $105
8010639e:	6a 69                	push   $0x69
  jmp alltraps
801063a0:	e9 a7 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063a5:	6a 00                	push   $0x0
  pushl $106
801063a7:	6a 6a                	push   $0x6a
  jmp alltraps
801063a9:	e9 9e f7 ff ff       	jmp    80105b4c <alltraps>
...
801063ae:	6a 00                	push   $0x0
  pushl $107
801063b0:	6a 6b                	push   $0x6b
  jmp alltraps
801063b2:	e9 95 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063b7:	6a 00                	push   $0x0
  pushl $108
801063b9:	6a 6c                	push   $0x6c
  jmp alltraps
801063bb:	e9 8c f7 ff ff       	jmp    80105b4c <alltraps>
...
801063c0:	6a 00                	push   $0x0
  pushl $109
801063c2:	6a 6d                	push   $0x6d
  jmp alltraps
801063c4:	e9 83 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063c9:	6a 00                	push   $0x0
  pushl $110
801063cb:	6a 6e                	push   $0x6e
  jmp alltraps
801063cd:	e9 7a f7 ff ff       	jmp    80105b4c <alltraps>
...
801063d2:	6a 00                	push   $0x0
  pushl $111
801063d4:	6a 6f                	push   $0x6f
  jmp alltraps
801063d6:	e9 71 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063db:	6a 00                	push   $0x0
  pushl $112
801063dd:	6a 70                	push   $0x70
  jmp alltraps
801063df:	e9 68 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063e4:	6a 00                	push   $0x0
  pushl $113
801063e6:	6a 71                	push   $0x71
  jmp alltraps
801063e8:	e9 5f f7 ff ff       	jmp    80105b4c <alltraps>
...
801063ed:	6a 00                	push   $0x0
  pushl $114
801063ef:	6a 72                	push   $0x72
  jmp alltraps
801063f1:	e9 56 f7 ff ff       	jmp    80105b4c <alltraps>
...
801063f6:	6a 00                	push   $0x0
  pushl $115
801063f8:	6a 73                	push   $0x73
  jmp alltraps
801063fa:	e9 4d f7 ff ff       	jmp    80105b4c <alltraps>
...
801063ff:	6a 00                	push   $0x0
  pushl $116
80106401:	6a 74                	push   $0x74
  jmp alltraps
80106403:	e9 44 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106408:	6a 00                	push   $0x0
  pushl $117
8010640a:	6a 75                	push   $0x75
  jmp alltraps
8010640c:	e9 3b f7 ff ff       	jmp    80105b4c <alltraps>
...
80106411:	6a 00                	push   $0x0
  pushl $118
80106413:	6a 76                	push   $0x76
  jmp alltraps
80106415:	e9 32 f7 ff ff       	jmp    80105b4c <alltraps>
...
8010641a:	6a 00                	push   $0x0
  pushl $119
8010641c:	6a 77                	push   $0x77
  jmp alltraps
8010641e:	e9 29 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106423:	6a 00                	push   $0x0
  pushl $120
80106425:	6a 78                	push   $0x78
  jmp alltraps
80106427:	e9 20 f7 ff ff       	jmp    80105b4c <alltraps>
...
8010642c:	6a 00                	push   $0x0
  pushl $121
8010642e:	6a 79                	push   $0x79
  jmp alltraps
80106430:	e9 17 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106435:	6a 00                	push   $0x0
  pushl $122
80106437:	6a 7a                	push   $0x7a
  jmp alltraps
80106439:	e9 0e f7 ff ff       	jmp    80105b4c <alltraps>
...
8010643e:	6a 00                	push   $0x0
  pushl $123
80106440:	6a 7b                	push   $0x7b
  jmp alltraps
80106442:	e9 05 f7 ff ff       	jmp    80105b4c <alltraps>
...
80106447:	6a 00                	push   $0x0
  pushl $124
80106449:	6a 7c                	push   $0x7c
  jmp alltraps
8010644b:	e9 fc f6 ff ff       	jmp    80105b4c <alltraps>
...
80106450:	6a 00                	push   $0x0
  pushl $125
80106452:	6a 7d                	push   $0x7d
  jmp alltraps
80106454:	e9 f3 f6 ff ff       	jmp    80105b4c <alltraps>
...
80106459:	6a 00                	push   $0x0
  pushl $126
8010645b:	6a 7e                	push   $0x7e
  jmp alltraps
8010645d:	e9 ea f6 ff ff       	jmp    80105b4c <alltraps>
...
80106462:	6a 00                	push   $0x0
  pushl $127
80106464:	6a 7f                	push   $0x7f
  jmp alltraps
80106466:	e9 e1 f6 ff ff       	jmp    80105b4c <alltraps>
...
8010646b:	6a 00                	push   $0x0
  pushl $128
8010646d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106472:	e9 d5 f6 ff ff       	jmp    80105b4c <alltraps>
...
80106477:	6a 00                	push   $0x0
  pushl $129
80106479:	68 81 00 00 00       	push   $0x81
  jmp alltraps
...
80106483:	6a 00                	push   $0x0
  pushl $130
80106485:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010648a:	e9 bd f6 ff ff       	jmp    80105b4c <alltraps>
...
8010648f:	6a 00                	push   $0x0
  pushl $131
80106491:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106496:	e9 b1 f6 ff ff       	jmp    80105b4c <alltraps>
...
8010649b:	6a 00                	push   $0x0
  pushl $132
8010649d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
...
801064a7:	6a 00                	push   $0x0
  pushl $133
801064a9:	68 85 00 00 00       	push   $0x85
  jmp alltraps
...
801064b3:	6a 00                	push   $0x0
  pushl $134
801064b5:	68 86 00 00 00       	push   $0x86
  jmp alltraps
...
801064bf:	6a 00                	push   $0x0
  pushl $135
801064c1:	68 87 00 00 00       	push   $0x87
  jmp alltraps
...
801064cb:	6a 00                	push   $0x0
  pushl $136
801064cd:	68 88 00 00 00       	push   $0x88
  jmp alltraps
...
801064d7:	6a 00                	push   $0x0
  pushl $137
801064d9:	68 89 00 00 00       	push   $0x89
  jmp alltraps
...
801064e3:	6a 00                	push   $0x0
  pushl $138
801064e5:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
...
801064ef:	6a 00                	push   $0x0
  pushl $139
801064f1:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
...
801064fb:	6a 00                	push   $0x0
  pushl $140
801064fd:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
...
80106507:	6a 00                	push   $0x0
  pushl $141
80106509:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
...
80106513:	6a 00                	push   $0x0
  pushl $142
80106515:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
...
8010651f:	6a 00                	push   $0x0
  pushl $143
80106521:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
...
8010652b:	6a 00                	push   $0x0
  pushl $144
8010652d:	68 90 00 00 00       	push   $0x90
  jmp alltraps
...
80106537:	6a 00                	push   $0x0
  pushl $145
80106539:	68 91 00 00 00       	push   $0x91
  jmp alltraps
...
80106543:	6a 00                	push   $0x0
  pushl $146
80106545:	68 92 00 00 00       	push   $0x92
  jmp alltraps
...
8010654f:	6a 00                	push   $0x0
  pushl $147
80106551:	68 93 00 00 00       	push   $0x93
  jmp alltraps
...
8010655b:	6a 00                	push   $0x0
  pushl $148
8010655d:	68 94 00 00 00       	push   $0x94
  jmp alltraps
...
80106567:	6a 00                	push   $0x0
  pushl $149
80106569:	68 95 00 00 00       	push   $0x95
  jmp alltraps
...
80106573:	6a 00                	push   $0x0
  pushl $150
80106575:	68 96 00 00 00       	push   $0x96
  jmp alltraps
...
8010657f:	6a 00                	push   $0x0
  pushl $151
80106581:	68 97 00 00 00       	push   $0x97
  jmp alltraps
...
8010658b:	6a 00                	push   $0x0
  pushl $152
8010658d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
...
80106597:	6a 00                	push   $0x0
  pushl $153
80106599:	68 99 00 00 00       	push   $0x99
  jmp alltraps
...
801065a3:	6a 00                	push   $0x0
  pushl $154
801065a5:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
...
801065af:	6a 00                	push   $0x0
  pushl $155
801065b1:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
...
801065bb:	6a 00                	push   $0x0
  pushl $156
801065bd:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
...
801065c7:	6a 00                	push   $0x0
  pushl $157
801065c9:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
...
801065d3:	6a 00                	push   $0x0
  pushl $158
801065d5:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
...
801065df:	6a 00                	push   $0x0
  pushl $159
801065e1:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
...
801065eb:	6a 00                	push   $0x0
  pushl $160
801065ed:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
...
801065f7:	6a 00                	push   $0x0
  pushl $161
801065f9:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
...
80106603:	6a 00                	push   $0x0
  pushl $162
80106605:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
...
8010660f:	6a 00                	push   $0x0
  pushl $163
80106611:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
...
8010661b:	6a 00                	push   $0x0
  pushl $164
8010661d:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
...
80106627:	6a 00                	push   $0x0
  pushl $165
80106629:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
...
80106633:	6a 00                	push   $0x0
  pushl $166
80106635:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
...
8010663f:	6a 00                	push   $0x0
  pushl $167
80106641:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
...
8010664b:	6a 00                	push   $0x0
  pushl $168
8010664d:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
...
80106657:	6a 00                	push   $0x0
  pushl $169
80106659:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
...
80106663:	6a 00                	push   $0x0
  pushl $170
80106665:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
...
8010666f:	6a 00                	push   $0x0
  pushl $171
80106671:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
...
8010667b:	6a 00                	push   $0x0
  pushl $172
8010667d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
...
80106687:	6a 00                	push   $0x0
  pushl $173
80106689:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
...
80106693:	6a 00                	push   $0x0
  pushl $174
80106695:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
...
8010669f:	6a 00                	push   $0x0
  pushl $175
801066a1:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
...
801066ab:	6a 00                	push   $0x0
  pushl $176
801066ad:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
...
801066b7:	6a 00                	push   $0x0
  pushl $177
801066b9:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
...
801066c3:	6a 00                	push   $0x0
  pushl $178
801066c5:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
...
801066cf:	6a 00                	push   $0x0
  pushl $179
801066d1:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
...
801066db:	6a 00                	push   $0x0
  pushl $180
801066dd:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
...
801066e7:	6a 00                	push   $0x0
  pushl $181
801066e9:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
...
801066f3:	6a 00                	push   $0x0
  pushl $182
801066f5:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
...
801066ff:	6a 00                	push   $0x0
  pushl $183
80106701:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
...
8010670b:	6a 00                	push   $0x0
  pushl $184
8010670d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
...
80106717:	6a 00                	push   $0x0
  pushl $185
80106719:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
...
80106723:	6a 00                	push   $0x0
  pushl $186
80106725:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
...
8010672f:	6a 00                	push   $0x0
  pushl $187
80106731:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
...
8010673b:	6a 00                	push   $0x0
  pushl $188
8010673d:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
...
80106747:	6a 00                	push   $0x0
  pushl $189
80106749:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
...
80106753:	6a 00                	push   $0x0
  pushl $190
80106755:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
...
8010675f:	6a 00                	push   $0x0
  pushl $191
80106761:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
...
8010676b:	6a 00                	push   $0x0
  pushl $192
8010676d:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
...
80106777:	6a 00                	push   $0x0
  pushl $193
80106779:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
...
80106783:	6a 00                	push   $0x0
  pushl $194
80106785:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
...
8010678f:	6a 00                	push   $0x0
  pushl $195
80106791:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
...
8010679b:	6a 00                	push   $0x0
  pushl $196
8010679d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
...
801067a7:	6a 00                	push   $0x0
  pushl $197
801067a9:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
...
801067b3:	6a 00                	push   $0x0
  pushl $198
801067b5:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
...
801067bf:	6a 00                	push   $0x0
  pushl $199
801067c1:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
...
801067cb:	6a 00                	push   $0x0
  pushl $200
801067cd:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
...
801067d7:	6a 00                	push   $0x0
  pushl $201
801067d9:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
...
801067e3:	6a 00                	push   $0x0
  pushl $202
801067e5:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
...
801067ef:	6a 00                	push   $0x0
  pushl $203
801067f1:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
...
801067fb:	6a 00                	push   $0x0
  pushl $204
801067fd:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
...
80106807:	6a 00                	push   $0x0
  pushl $205
80106809:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
...
80106813:	6a 00                	push   $0x0
  pushl $206
80106815:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
...
8010681f:	6a 00                	push   $0x0
  pushl $207
80106821:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
...
8010682b:	6a 00                	push   $0x0
  pushl $208
8010682d:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
...
80106837:	6a 00                	push   $0x0
  pushl $209
80106839:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
...
80106843:	6a 00                	push   $0x0
  pushl $210
80106845:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
...
8010684f:	6a 00                	push   $0x0
  pushl $211
80106851:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
...
8010685b:	6a 00                	push   $0x0
  pushl $212
8010685d:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
...
80106867:	6a 00                	push   $0x0
  pushl $213
80106869:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
...
80106873:	6a 00                	push   $0x0
  pushl $214
80106875:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
...
8010687f:	6a 00                	push   $0x0
  pushl $215
80106881:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
...
8010688b:	6a 00                	push   $0x0
  pushl $216
8010688d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
...
80106897:	6a 00                	push   $0x0
  pushl $217
80106899:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
...
801068a3:	6a 00                	push   $0x0
  pushl $218
801068a5:	68 da 00 00 00       	push   $0xda
  jmp alltraps
...
801068af:	6a 00                	push   $0x0
  pushl $219
801068b1:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
...
801068bb:	6a 00                	push   $0x0
  pushl $220
801068bd:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
...
801068c7:	6a 00                	push   $0x0
  pushl $221
801068c9:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
...
801068d3:	6a 00                	push   $0x0
  pushl $222
801068d5:	68 de 00 00 00       	push   $0xde
  jmp alltraps
...
801068df:	6a 00                	push   $0x0
  pushl $223
801068e1:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
...
801068eb:	6a 00                	push   $0x0
  pushl $224
801068ed:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
...
801068f7:	6a 00                	push   $0x0
  pushl $225
801068f9:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
...
80106903:	6a 00                	push   $0x0
  pushl $226
80106905:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
...
8010690f:	6a 00                	push   $0x0
  pushl $227
80106911:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
...
8010691b:	6a 00                	push   $0x0
  pushl $228
8010691d:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
...
80106927:	6a 00                	push   $0x0
  pushl $229
80106929:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
...
80106933:	6a 00                	push   $0x0
  pushl $230
80106935:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
...
8010693f:	6a 00                	push   $0x0
  pushl $231
80106941:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
...
8010694b:	6a 00                	push   $0x0
  pushl $232
8010694d:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
...
80106957:	6a 00                	push   $0x0
  pushl $233
80106959:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
...
80106963:	6a 00                	push   $0x0
  pushl $234
80106965:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
...
8010696f:	6a 00                	push   $0x0
  pushl $235
80106971:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
...
8010697b:	6a 00                	push   $0x0
  pushl $236
8010697d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
...
80106987:	6a 00                	push   $0x0
  pushl $237
80106989:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
...
80106993:	6a 00                	push   $0x0
  pushl $238
80106995:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
...
8010699f:	6a 00                	push   $0x0
  pushl $239
801069a1:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
...
801069ab:	6a 00                	push   $0x0
  pushl $240
801069ad:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
...
801069b7:	6a 00                	push   $0x0
  pushl $241
801069b9:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
...
801069c3:	6a 00                	push   $0x0
  pushl $242
801069c5:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
...
801069cf:	6a 00                	push   $0x0
  pushl $243
801069d1:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
...
801069db:	6a 00                	push   $0x0
  pushl $244
801069dd:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
...
801069e7:	6a 00                	push   $0x0
  pushl $245
801069e9:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
...
801069f3:	6a 00                	push   $0x0
  pushl $246
801069f5:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
...
801069ff:	6a 00                	push   $0x0
  pushl $247
80106a01:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
...
80106a0b:	6a 00                	push   $0x0
  pushl $248
80106a0d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
...
80106a17:	6a 00                	push   $0x0
  pushl $249
80106a19:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
...
80106a23:	6a 00                	push   $0x0
  pushl $250
80106a25:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
...
80106a2f:	6a 00                	push   $0x0
  pushl $251
80106a31:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
...
80106a3b:	6a 00                	push   $0x0
  pushl $252
80106a3d:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
...
80106a47:	6a 00                	push   $0x0
  pushl $253
80106a49:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
...
80106a53:	6a 00                	push   $0x0
  pushl $254
80106a55:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
...
80106a5f:	6a 00                	push   $0x0
  pushl $255
80106a61:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
...
80106a96:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106a99:	c1 e8 0a             	shr    $0xa,%eax
80106a9c:	25 fc 0f 00 00       	and    $0xffc,%eax
80106aa1:	01 d8                	add    %ebx,%eax
}
80106aa3:	5b                   	pop    %ebx
80106aa4:	5e                   	pop    %esi
80106aa5:	5f                   	pop    %edi
...
80106ab4:	e8 77 bb ff ff       	call   80102630 <kalloc>
80106ab9:	89 c3                	mov    %eax,%ebx
...
80106af4:	89 c7                	mov    %eax,%edi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106af6:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
{
80106afa:	56                   	push   %esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106afb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
80106b00:	89 d6                	mov    %edx,%esi
{
80106b02:	53                   	push   %ebx
  a = (char*)PGROUNDDOWN((uint)va);
80106b03:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
{
80106b09:	83 ec 1c             	sub    $0x1c,%esp
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106b0c:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106b0f:	8b 45 08             	mov    0x8(%ebp),%eax
80106b12:	29 f0                	sub    %esi,%eax
80106b14:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106b17:	eb 1f                	jmp    80106b38 <mappages+0x48>
...
80106b23:	75 45                	jne    80106b6a <mappages+0x7a>
      panic("remap");
    *pte = pa | perm | PTE_P;
80106b25:	0b 5d 0c             	or     0xc(%ebp),%ebx
80106b28:	83 cb 01             	or     $0x1,%ebx
80106b2b:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106b2d:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106b30:	74 2e                	je     80106b60 <mappages+0x70>
      break;
    a += PGSIZE;
80106b32:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106b38:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106b3b:	b9 01 00 00 00       	mov    $0x1,%ecx
80106b40:	89 f2                	mov    %esi,%edx
80106b42:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106b45:	89 f8                	mov    %edi,%eax
80106b47:	e8 24 ff ff ff       	call   80106a70 <walkpgdir>
80106b4c:	85 c0                	test   %eax,%eax
80106b4e:	75 d0                	jne    80106b20 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
...
80106b6d:	68 dc 7c 10 80       	push   $0x80107cdc
...
80106b88:	89 d3                	mov    %edx,%ebx
  ...
  a = PGROUNDUP(newsz);
80106b8a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106b90:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106b96:	83 ec 1c             	sub    $0x1c,%esp
80106b99:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106b9c:	39 da                	cmp    %ebx,%edx
80106b9e:	73 5b                	jae    80106bfb <deallocuvm.part.0+0x7b>
80106ba0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
80106ba3:	89 d7                	mov    %edx,%edi
80106ba5:	eb 14                	jmp    80106bbb <deallocuvm.part.0+0x3b>
80106ba7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106bae:	66 90                	xchg   %ax,%ax
80106bb0:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106bb6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106bb9:	76 40                	jbe    80106bfb <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106bbb:	31 c9                	xor    %ecx,%ecx
80106bbd:	89 fa                	mov    %edi,%edx
80106bbf:	89 f0                	mov    %esi,%eax
80106bc1:	e8 aa fe ff ff       	call   80106a70 <walkpgdir>
80106bc6:	89 c3                	mov    %eax,%ebx
    if(!pte)
80106bc8:	85 c0                	test   %eax,%eax
80106bca:	74 44                	je     80106c10 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106bcc:	8b 00                	mov    (%eax),%eax
80106bce:	a8 01                	test   $0x1,%al
80106bd0:	74 de                	je     80106bb0 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106bd2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106bd7:	74 47                	je     80106c20 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106bd9:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106bdc:	05 00 00 00 80       	add    $0x80000000,%eax
80106be1:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
80106be7:	50                   	push   %eax
80106be8:	e8 83 b8 ff ff       	call   80102470 <kfree>
      *pte = 0;
80106bed:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
80106bf3:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106bf6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
80106bf9:	77 c0                	ja     80106bbb <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
...
80106c0d:	8d 76 00             	lea    0x0(%esi),%esi
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106c10:	89 fa                	mov    %edi,%edx
80106c12:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106c18:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
80106c1e:	eb 96                	jmp    80106bb6 <deallocuvm.part.0+0x36>
        panic("kfree");
80106c20:	83 ec 0c             	sub    $0xc,%esp
80106c23:	68 26 76 10 80       	push   $0x80107626
...
80106c37:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106c3a:	e8 01 cd ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
80106c3f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106c44:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106c4a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106c4e:	c7 80 98 29 11 80 ff 	movl   $0xffff,-0x7feed668(%eax)
80106c55:	ff 00 00 
80106c58:	c7 80 9c 29 11 80 00 	movl   $0xcf9a00,-0x7feed664(%eax)
80106c5f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106c62:	c7 80 a0 29 11 80 ff 	movl   $0xffff,-0x7feed660(%eax)
80106c69:	ff 00 00 
80106c6c:	c7 80 a4 29 11 80 00 	movl   $0xcf9200,-0x7feed65c(%eax)
80106c73:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106c76:	c7 80 a8 29 11 80 ff 	movl   $0xffff,-0x7feed658(%eax)
80106c7d:	ff 00 00 
80106c80:	c7 80 ac 29 11 80 00 	movl   $0xcffa00,-0x7feed654(%eax)
80106c87:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106c8a:	c7 80 b0 29 11 80 ff 	movl   $0xffff,-0x7feed650(%eax)
80106c91:	ff 00 00 
80106c94:	c7 80 b4 29 11 80 00 	movl   $0xcff200,-0x7feed64c(%eax)
80106c9b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106c9e:	05 90 29 11 80       	add    $0x80112990,%eax
  pd[1] = (uint)p;
...
80106cc4:	a1 84 57 11 80       	mov    0x80115784,%eax
80106cc9:	05 00 00 00 80       	add    $0x80000000,%eax
}
...
80106ced:	8b 75 08             	mov    0x8(%ebp),%esi
  if(p == 0)
80106cf0:	85 f6                	test   %esi,%esi
80106cf2:	0f 84 cb 00 00 00    	je     80106dc3 <switchuvm+0xe3>
  if(p->kstack == 0)
80106cf8:	8b 46 08             	mov    0x8(%esi),%eax
80106cfb:	85 c0                	test   %eax,%eax
80106cfd:	0f 84 da 00 00 00    	je     80106ddd <switchuvm+0xfd>
  if(p->pgdir == 0)
80106d03:	8b 46 04             	mov    0x4(%esi),%eax
80106d06:	85 c0                	test   %eax,%eax
80106d08:	0f 84 c2 00 00 00    	je     80106dd0 <switchuvm+0xf0>
  pushcli();
80106d0e:	e8 ed d8 ff ff       	call   80104600 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d13:	e8 b8 cb ff ff       	call   801038d0 <mycpu>
80106d18:	89 c3                	mov    %eax,%ebx
80106d1a:	e8 b1 cb ff ff       	call   801038d0 <mycpu>
80106d1f:	89 c7                	mov    %eax,%edi
80106d21:	e8 aa cb ff ff       	call   801038d0 <mycpu>
80106d26:	83 c7 08             	add    $0x8,%edi
80106d29:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d2c:	e8 9f cb ff ff       	call   801038d0 <mycpu>
80106d31:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106d34:	ba 67 00 00 00       	mov    $0x67,%edx
80106d39:	66 89 bb 9a 00 00 00 	mov    %di,0x9a(%ebx)
80106d40:	83 c0 08             	add    $0x8,%eax
80106d43:	66 89 93 98 00 00 00 	mov    %dx,0x98(%ebx)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d4a:	bf ff ff ff ff       	mov    $0xffffffff,%edi
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106d4f:	83 c1 08             	add    $0x8,%ecx
80106d52:	c1 e8 18             	shr    $0x18,%eax
80106d55:	c1 e9 10             	shr    $0x10,%ecx
80106d58:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
80106d5e:	88 8b 9c 00 00 00    	mov    %cl,0x9c(%ebx)
80106d64:	b9 99 40 00 00       	mov    $0x4099,%ecx
80106d69:	66 89 8b 9d 00 00 00 	mov    %cx,0x9d(%ebx)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d70:	bb 10 00 00 00       	mov    $0x10,%ebx
  mycpu()->gdt[SEG_TSS].s = 0;
80106d75:	e8 56 cb ff ff       	call   801038d0 <mycpu>
80106d7a:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106d81:	e8 4a cb ff ff       	call   801038d0 <mycpu>
80106d86:	66 89 58 10          	mov    %bx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106d8a:	8b 5e 08             	mov    0x8(%esi),%ebx
80106d8d:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106d93:	e8 38 cb ff ff       	call   801038d0 <mycpu>
80106d98:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106d9b:	e8 30 cb ff ff       	call   801038d0 <mycpu>
80106da0:	66 89 78 6e          	mov    %di,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
80106da4:	b8 28 00 00 00       	mov    $0x28,%eax
80106da9:	0f 00 d8             	ltr    %ax
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106dac:	8b 46 04             	mov    0x4(%esi),%eax
80106daf:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
80106db4:	0f 22 d8             	mov    %eax,%cr3
}
...
80106dbd:	5d                   	pop    %ebp
  popcli();
80106dbe:	e9 8d d8 ff ff       	jmp    80104650 <popcli>
    panic("switchuvm: no process");
80106dc3:	83 ec 0c             	sub    $0xc,%esp
80106dc6:	68 e2 7c 10 80       	push   $0x80107ce2
80106dcb:	e8 c0 95 ff ff       	call   80100390 <panic>
    panic("switchuvm: no pgdir");
80106dd0:	83 ec 0c             	sub    $0xc,%esp
80106dd3:	68 0d 7d 10 80       	push   $0x80107d0d
80106dd8:	e8 b3 95 ff ff       	call   80100390 <panic>
    panic("switchuvm: no kstack");
80106ddd:	83 ec 0c             	sub    $0xc,%esp
80106de0:	68 f8 7c 10 80       	push   $0x80107cf8
...
80106e00:	8b 75 10             	mov    0x10(%ebp),%esi
80106e03:	8b 7d 08             	mov    0x8(%ebp),%edi
80106e06:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106e09:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106e0f:	77 4b                	ja     80106e5c <inituvm+0x6c>
  mem = kalloc();
80106e11:	e8 1a b8 ff ff       	call   80102630 <kalloc>
  memset(mem, 0, PGSIZE);
80106e16:	83 ec 04             	sub    $0x4,%esp
80106e19:	68 00 10 00 00       	push   $0x1000
  mem = kalloc();
80106e1e:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106e20:	6a 00                	push   $0x0
80106e22:	50                   	push   %eax
80106e23:	e8 28 da ff ff       	call   80104850 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106e28:	58                   	pop    %eax
80106e29:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106e2f:	5a                   	pop    %edx
80106e30:	6a 06                	push   $0x6
80106e32:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106e37:	31 d2                	xor    %edx,%edx
80106e39:	50                   	push   %eax
80106e3a:	89 f8                	mov    %edi,%eax
80106e3c:	e8 af fc ff ff       	call   80106af0 <mappages>
  memmove(mem, init, sz);
80106e41:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106e44:	89 75 10             	mov    %esi,0x10(%ebp)
80106e47:	83 c4 10             	add    $0x10,%esp
80106e4a:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106e4d:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106e56:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106e57:	e9 94 da ff ff       	jmp    801048f0 <memmove>
    panic("inituvm: more than a page");
80106e5c:	83 ec 0c             	sub    $0xc,%esp
80106e5f:	68 21 7d 10 80       	push   $0x80107d21
...
80106e80:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106e83:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106e88:	0f 85 99 00 00 00    	jne    80106f27 <loaduvm+0xb7>
  for(i = 0; i < sz; i += PGSIZE){
80106e8e:	01 f0                	add    %esi,%eax
80106e90:	89 f3                	mov    %esi,%ebx
80106e92:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106e95:	8b 45 14             	mov    0x14(%ebp),%eax
80106e98:	01 f0                	add    %esi,%eax
80106e9a:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106e9d:	85 f6                	test   %esi,%esi
80106e9f:	75 15                	jne    80106eb6 <loaduvm+0x46>
80106ea1:	eb 6d                	jmp    80106f10 <loaduvm+0xa0>
80106ea3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106ea7:	90                   	nop
80106ea8:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106eae:	89 f0                	mov    %esi,%eax
80106eb0:	29 d8                	sub    %ebx,%eax
80106eb2:	39 c6                	cmp    %eax,%esi
80106eb4:	76 5a                	jbe    80106f10 <loaduvm+0xa0>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106eb6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106eb9:	8b 45 08             	mov    0x8(%ebp),%eax
80106ebc:	31 c9                	xor    %ecx,%ecx
80106ebe:	29 da                	sub    %ebx,%edx
80106ec0:	e8 ab fb ff ff       	call   80106a70 <walkpgdir>
80106ec5:	85 c0                	test   %eax,%eax
80106ec7:	74 51                	je     80106f1a <loaduvm+0xaa>
    pa = PTE_ADDR(*pte);
80106ec9:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106ecb:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106ece:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106ed3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106ed8:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106ede:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106ee1:	29 d9                	sub    %ebx,%ecx
80106ee3:	05 00 00 00 80       	add    $0x80000000,%eax
80106ee8:	57                   	push   %edi
80106ee9:	51                   	push   %ecx
80106eea:	50                   	push   %eax
80106eeb:	ff 75 10             	pushl  0x10(%ebp)
80106eee:	e8 6d ab ff ff       	call   80101a60 <readi>
80106ef3:	83 c4 10             	add    $0x10,%esp
80106ef6:	39 f8                	cmp    %edi,%eax
80106ef8:	74 ae                	je     80106ea8 <loaduvm+0x38>
}
...
80106f1d:	68 3b 7d 10 80       	push   $0x80107d3b
80106f22:	e8 69 94 ff ff       	call   80100390 <panic>
    panic("loaduvm: addr must be page aligned");
80106f27:	83 ec 0c             	sub    $0xc,%esp
80106f2a:	68 dc 7d 10 80       	push   $0x80107ddc
80106f2f:	e8 5c 94 ff ff       	call   80100390 <panic>
...
80106f4a:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106f4d:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106f50:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106f53:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106f56:	85 c0                	test   %eax,%eax
80106f58:	0f 88 b2 00 00 00    	js     80107010 <allocuvm+0xd0>
  if(newsz < oldsz)
80106f5e:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106f61:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106f64:	0f 82 96 00 00 00    	jb     80107000 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106f6a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106f70:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106f76:	39 75 10             	cmp    %esi,0x10(%ebp)
80106f79:	77 40                	ja     80106fbb <allocuvm+0x7b>
80106f7b:	e9 83 00 00 00       	jmp    80107003 <allocuvm+0xc3>
    memset(mem, 0, PGSIZE);
80106f80:	83 ec 04             	sub    $0x4,%esp
80106f83:	68 00 10 00 00       	push   $0x1000
80106f88:	6a 00                	push   $0x0
80106f8a:	50                   	push   %eax
80106f8b:	e8 c0 d8 ff ff       	call   80104850 <memset>
...
80106fa4:	e8 47 fb ff ff       	call   80106af0 <mappages>
...
80106fb9:	76 48                	jbe    80107003 <allocuvm+0xc3>
    mem = kalloc();
80106fbb:	e8 70 b6 ff ff       	call   80102630 <kalloc>
...
80106fc9:	68 59 7d 10 80       	push   $0x80107d59
80106fce:	e8 dd 96 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80106fe5:	e8 96 fb ff ff       	call   80106b80 <deallocuvm.part.0>
      return 0;
...
8010702b:	68 71 7d 10 80       	push   $0x80107d71
80107030:	e8 7b 96 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
...
80107047:	e8 34 fb ff ff       	call   80106b80 <deallocuvm.part.0>
      kfree(mem);
8010704c:	83 ec 0c             	sub    $0xc,%esp
8010704f:	53                   	push   %ebx
80107050:	e8 1b b4 ff ff       	call   80102470 <kfree>
      return 0;
...
80107077:	8b 55 0c             	mov    0xc(%ebp),%edx
8010707a:	8b 4d 10             	mov    0x10(%ebp),%ecx
8010707d:	8b 45 08             	mov    0x8(%ebp),%eax
  if(newsz >= oldsz)
80107080:	39 d1                	cmp    %edx,%ecx
80107082:	73 0c                	jae    80107090 <deallocuvm+0x20>
}
80107084:	5d                   	pop    %ebp
80107085:	e9 f6 fa ff ff       	jmp    80106b80 <deallocuvm.part.0>
...
801070ad:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
801070b0:	85 f6                	test   %esi,%esi
801070b2:	74 55                	je     80107109 <freevm+0x69>
  if(newsz >= oldsz)
801070b4:	31 c9                	xor    %ecx,%ecx
801070b6:	ba 00 00 00 80       	mov    $0x80000000,%edx
801070bb:	89 f0                	mov    %esi,%eax
801070bd:	89 f3                	mov    %esi,%ebx
801070bf:	e8 bc fa ff ff       	call   80106b80 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
801070c4:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
801070ca:	eb 0b                	jmp    801070d7 <freevm+0x37>
...
801070ee:	e8 7d b3 ff ff       	call   80102470 <kfree>
...
80107103:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107104:	e9 67 b3 ff ff       	jmp    80102470 <kfree>
    panic("freevm: no pgdir");
80107109:	83 ec 0c             	sub    $0xc,%esp
8010710c:	68 8d 7d 10 80       	push   $0x80107d8d
...
80107127:	56                   	push   %esi
80107128:	53                   	push   %ebx
  if((pgdir = (pde_t*)kalloc()) == 0)
80107129:	e8 02 b5 ff ff       	call   80102630 <kalloc>
8010712e:	89 c6                	mov    %eax,%esi
80107130:	85 c0                	test   %eax,%eax
80107132:	74 42                	je     80107176 <setupkvm+0x56>
  memset(pgdir, 0, PGSIZE);
80107134:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107137:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
8010713c:	68 00 10 00 00       	push   $0x1000
80107141:	6a 00                	push   $0x0
80107143:	50                   	push   %eax
80107144:	e8 07 d7 ff ff       	call   80104850 <memset>
80107149:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
8010714c:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010714f:	83 ec 08             	sub    $0x8,%esp
80107152:	8b 4b 08             	mov    0x8(%ebx),%ecx
80107155:	ff 73 0c             	pushl  0xc(%ebx)
80107158:	8b 13                	mov    (%ebx),%edx
8010715a:	50                   	push   %eax
8010715b:	29 c1                	sub    %eax,%ecx
8010715d:	89 f0                	mov    %esi,%eax
8010715f:	e8 8c f9 ff ff       	call   80106af0 <mappages>
80107164:	83 c4 10             	add    $0x10,%esp
80107167:	85 c0                	test   %eax,%eax
80107169:	78 15                	js     80107180 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
8010716b:	83 c3 10             	add    $0x10,%ebx
8010716e:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80107174:	75 d6                	jne    8010714c <setupkvm+0x2c>
}
80107176:	8d 65 f8             	lea    -0x8(%ebp),%esp
...
801071a7:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801071aa:	e8 71 ff ff ff       	call   80107120 <setupkvm>
801071af:	a3 84 57 11 80       	mov    %eax,0x80115784
  lcr3(V2P(kpgdir));   // switch to the kernel page table
801071b4:	05 00 00 00 80       	add    $0x80000000,%eax
801071b9:	0f 22 d8             	mov    %eax,%cr3
}
801071bc:	c9                   	leave  
801071bd:	c3                   	ret    
...
801071d2:	e8 99 f8 ff ff       	call   80106a70 <walkpgdir>
  if(pte == 0)
801071d7:	85 c0                	test   %eax,%eax
801071d9:	74 05                	je     801071e0 <clearpteu+0x20>
    panic("clearpteu");
  *pte &= ~PTE_U;
801071db:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
801071de:	c9                   	leave  
801071df:	c3                   	ret    
    panic("clearpteu");
801071e0:	83 ec 0c             	sub    $0xc,%esp
801071e3:	68 9e 7d 10 80       	push   $0x80107d9e
...
801071fa:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
801071fd:	e8 1e ff ff ff       	call   80107120 <setupkvm>
80107202:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107205:	85 c0                	test   %eax,%eax
80107207:	0f 84 9b 00 00 00    	je     801072a8 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010720d:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80107210:	85 c9                	test   %ecx,%ecx
80107212:	0f 84 90 00 00 00    	je     801072a8 <copyuvm+0xb8>
80107218:	31 f6                	xor    %esi,%esi
8010721a:	eb 46                	jmp    80107262 <copyuvm+0x72>
...
80107230:	e8 bb d6 ff ff       	call   801048f0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107235:	58                   	pop    %eax
80107236:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
8010723c:	5a                   	pop    %edx
8010723d:	ff 75 e4             	pushl  -0x1c(%ebp)
...
80107255:	78 61                	js     801072b8 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80107257:	81 c6 00 10 00 00    	add    $0x1000,%esi
8010725d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80107260:	76 46                	jbe    801072a8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107262:	8b 45 08             	mov    0x8(%ebp),%eax
80107265:	31 c9                	xor    %ecx,%ecx
80107267:	89 f2                	mov    %esi,%edx
80107269:	e8 02 f8 ff ff       	call   80106a70 <walkpgdir>
8010726e:	85 c0                	test   %eax,%eax
80107270:	74 61                	je     801072d3 <copyuvm+0xe3>
    if(!(*pte & PTE_P))
80107272:	8b 00                	mov    (%eax),%eax
80107274:	a8 01                	test   $0x1,%al
80107276:	74 4e                	je     801072c6 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80107278:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
8010727a:	25 ff 0f 00 00       	and    $0xfff,%eax
8010727f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107282:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107288:	e8 a3 b3 ff ff       	call   80102630 <kalloc>
8010728d:	89 c3                	mov    %eax,%ebx
8010728f:	85 c0                	test   %eax,%eax
80107291:	75 8d                	jne    80107220 <copyuvm+0x30>
    }
  }
  return d;
...
80107299:	e8 02 fe ff ff       	call   801070a0 <freevm>
  return 0;
8010729e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801072bc:	e8 af b1 ff ff       	call   80102470 <kfree>
      goto bad;
801072c1:	83 c4 10             	add    $0x10,%esp
801072c4:	eb cd                	jmp    80107293 <copyuvm+0xa3>
      panic("copyuvm: page not present");
801072c6:	83 ec 0c             	sub    $0xc,%esp
801072c9:	68 c2 7d 10 80       	push   $0x80107dc2
801072ce:	e8 bd 90 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801072d3:	83 ec 0c             	sub    $0xc,%esp
801072d6:	68 a8 7d 10 80       	push   $0x80107da8
801072db:	e8 b0 90 ff ff       	call   80100390 <panic>
...
801072f2:	e8 79 f7 ff ff       	call   80106a70 <walkpgdir>
  if((*pte & PTE_P) == 0)
801072f7:	8b 00                	mov    (%eax),%eax
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801072f9:	c9                   	leave  
  if((*pte & PTE_U) == 0)
801072fa:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
801072fc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
80107301:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107304:	05 00 00 00 80       	add    $0x80000000,%eax
80107309:	83 fa 05             	cmp    $0x5,%edx
8010730c:	ba 00 00 00 00       	mov    $0x0,%edx
80107311:	0f 45 c2             	cmovne %edx,%eax
}
80107314:	c3                   	ret    
...
8010732d:	8b 75 14             	mov    0x14(%ebp),%esi
80107330:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  buf = (char*)p;
  while(len > 0){
80107333:	85 f6                	test   %esi,%esi
80107335:	75 3c                	jne    80107373 <copyout+0x53>
80107337:	eb 67                	jmp    801073a0 <copyout+0x80>
...
80107345:	29 d3                	sub    %edx,%ebx
80107347:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010734d:	39 f3                	cmp    %esi,%ebx
8010734f:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107352:	29 fa                	sub    %edi,%edx
80107354:	83 ec 04             	sub    $0x4,%esp
80107357:	01 c2                	add    %eax,%edx
80107359:	53                   	push   %ebx
8010735a:	ff 75 10             	pushl  0x10(%ebp)
8010735d:	52                   	push   %edx
8010735e:	e8 8d d5 ff ff       	call   801048f0 <memmove>
    len -= n;
    buf += n;
80107363:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
80107366:	8d 97 00 10 00 00    	lea    0x1000(%edi),%edx
  while(len > 0){
8010736c:	83 c4 10             	add    $0x10,%esp
8010736f:	29 de                	sub    %ebx,%esi
80107371:	74 2d                	je     801073a0 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
80107373:	89 d7                	mov    %edx,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107375:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
80107378:	89 55 0c             	mov    %edx,0xc(%ebp)
8010737b:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    pa0 = uva2ka(pgdir, (char*)va0);
80107381:	57                   	push   %edi
80107382:	ff 75 08             	pushl  0x8(%ebp)
80107385:	e8 56 ff ff ff       	call   801072e0 <uva2ka>
    if(pa0 == 0)
8010738a:	83 c4 10             	add    $0x10,%esp
8010738d:	85 c0                	test   %eax,%eax
8010738f:	75 af                	jne    80107340 <copyout+0x20>
  }
  return 0;
}
80107391:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80107394:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107399:	5b                   	pop    %ebx
8010739a:	5e                   	pop    %esi
8010739b:	5f                   	pop    %edi
