...
_BJF_proc_level:     file format elf32-i386
...
{ 
  ...
  2f:	89 c6                	mov    %eax,%esi
        arg2 = atoi(argv[2]);
  31:	e8 3a 02 00 00       	call   270 <atoi>
        arg3 = atoi(argv[3]);
  36:	59                   	pop    %ecx
  37:	ff 73 0c             	pushl  0xc(%ebx)
        arg2 = atoi(argv[2]);
  3a:	89 c7                	mov    %eax,%edi
        arg3 = atoi(argv[3]);
  3c:	e8 2f 02 00 00       	call   270 <atoi>
  41:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        arg4 = atoi(argv[4]);
  44:	58                   	pop    %eax
  45:	ff 73 10             	pushl  0x10(%ebx)
  48:	e8 23 02 00 00       	call   270 <atoi>
    else {
...
00000383 <find_next_prime_number>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	eb 1a                	jmp    640 <printf+0x1a0>
          s = "(null)";
 626:	bb 1d 08 00 00       	mov    $0x81d,%ebx
        while(*s != 0){
 ...
 696:	73 10                	jae    6a8 <free+0x38>
{
 ...
 6e7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ea:	a3 d8 0a 00 00       	mov    %eax,0xad8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 70d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 710:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 759:	8b 3d d8 0a 00 00    	mov    0xad8,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 d8 0a 00 00       	mov    0xad8,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 d8 0a 00 00       	mov    %eax,0xad8
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 d8 0a 00 00 dc 	movl   $0xadc,0xad8
 7d7:	0a 00 00 
    base.s.size = 0;
 7da:	bf dc 0a 00 00       	mov    $0xadc,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 dc 0a 00 00 dc 	movl   $0xadc,0xadc
 7e6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 e0 0a 00 00 00 	movl   $0x0,0xae0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
