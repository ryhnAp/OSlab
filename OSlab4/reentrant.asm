...
_reentrant:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  25:	89 c3                	mov    %eax,%ebx
    printf(1, "Running %d times acquire :\n", count);
  27:	68 c8 07 00 00       	push   $0x7c8
  2c:	6a 01                	push   $0x1
  2e:	e8 2d 04 00 00       	call   460 <printf>
    reentrant(count);
  33:	89 1c 24             	mov    %ebx,(%esp)
  36:	e8 60 03 00 00       	call   39b <reentrant>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb e4 07 00 00       	mov    $0x7e4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 98 0a 00 00       	mov    %eax,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 98 0a 00 00       	mov    0xa98,%eax
 ...
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 7b2:	00 00 00 
    if(p->s.size >= nunits){
