...
_print_process:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  29:	83 c4 10             	add    $0x10,%esp
    ...
    print_process();    
  2c:	e8 3a 03 00 00       	call   36b <print_process>
    exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb de 07 00 00       	mov    $0x7de,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 635:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 90 0a 00 00 94 	movl   $0xa94,0xa90
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf 94 0a 00 00       	mov    $0xa94,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 7b2:	00 00 00 
    if(p->s.size >= nunits){
