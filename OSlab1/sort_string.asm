...
000000d0 <sorting>:
{
  ...
  e5:	ff 35 2c 0c 00 00    	pushl  0xc2c
 ...
 183:	68 d8 08 00 00       	push   $0x8d8
 188:	6a 01                	push   $0x1
 18a:	e8 e1 03 00 00       	call   570 <printf>
 18f:	83 c4 10             	add    $0x10,%esp
 192:	e9 66 ff ff ff       	jmp    fd <sorting+0x2d>
        printf(1, "Unable to write in file.\n");
 197:	50                   	push   %eax
 198:	50                   	push   %eax
 199:	68 f2 08 00 00       	push   $0x8f2
 19e:	6a 01                	push   $0x1
 1a0:	e8 cb 03 00 00       	call   570 <printf>
        exit();
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 28 09 00 00 	movzbl 0x928(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6f4:	eb 1a                	jmp    710 <printf+0x1a0>
          s = "(null)";
 6f6:	bb 20 09 00 00       	mov    $0x920,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 745:	a1 30 0c 00 00       	mov    0xc30,%eax
{
...
malloc(uint nbytes)
{
 ...
 7dd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7e0:	8b 3d 30 0c 00 00    	mov    0xc30,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 852:	e8 e9 fe ff ff       	call   740 <free>
  return freep;
 857:	a1 30 0c 00 00       	mov    0xc30,%eax
 ...
 884:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 887:	a3 30 0c 00 00       	mov    %eax,0xc30
}
