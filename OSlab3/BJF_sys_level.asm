...
_BJF_sys_level:     file format elf32-i386
...
{ 
  1b:	8b 59 04             	mov    0x4(%ecx),%ebx
    if(argc > 3) {
  1e:	7e 31                	jle    51 <main+0x51>
        arg1 = atoi(argv[1]);
  20:	83 ec 0c             	sub    $0xc,%esp
  23:	ff 73 04             	pushl  0x4(%ebx)
  26:	e8 35 02 00 00       	call   260 <atoi>
        arg2 = atoi(argv[2]);
  2b:	5a                   	pop    %edx
  ...
  2f:	89 c6                	mov    %eax,%esi
        arg2 = atoi(argv[2]);
  31:	e8 2a 02 00 00       	call   260 <atoi>
        arg3 = atoi(argv[3]);
  36:	59                   	pop    %ecx
  ...
  3a:	89 c7                	mov    %eax,%edi
        arg3 = atoi(argv[3]);
  3c:	e8 1f 02 00 00       	call   260 <atoi>
    else {
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	eb 1a                	jmp    610 <printf+0x1a0>
          s = "(null)";
 5f6:	bb ed 07 00 00       	mov    $0x7ed,%ebx
        while(*s != 0){
