...
int main(int argc, char* argv[]) 
{
  ...
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 57 08 00 00       	push   $0x857
  37:	6a 01                	push   $0x1
  39:	e8 92 04 00 00       	call   4d0 <printf>
    	printf(1, "Child2 and Main Process needs to wait for child one fork and feedback done.\n");
  3e:	5a                   	pop    %edx
  3f:	59                   	pop    %ecx
  40:	68 fc 08 00 00       	push   $0x8fc
  45:	6a 01                	push   $0x1
 ...
 42c:	89 d1                	mov    %edx,%ecx
{
 ...
 459:	0f b6 92 50 09 00 00 	movzbl 0x950(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 654:	eb 1a                	jmp    670 <printf+0x1a0>
          s = "(null)";
 656:	bb 49 09 00 00       	mov    $0x949,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6a5:	a1 04 0c 00 00       	mov    0xc04,%eax
{
 ...
 6c6:	73 10                	jae    6d8 <free+0x38>
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	a3 04 0c 00 00       	mov    %eax,0xc04
}
 6f7:	5e                   	pop    %esi
 6f8:	5f                   	pop    %edi
 6f9:	5d                   	pop    %ebp
 ...
 717:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 71a:	a3 04 0c 00 00       	mov    %eax,0xc04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 73d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 740:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 789:	8b 3d 04 0c 00 00    	mov    0xc04,%edi
 ...
 7b2:	e8 e9 fe ff ff       	call   6a0 <free>
  return freep;
 7b7:	a1 04 0c 00 00       	mov    0xc04,%eax
 ...
 7e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7e7:	a3 04 0c 00 00       	mov    %eax,0xc04
}
