...
int main(int argc, char *argv[])
{
  ...
  6a:	d9 ee                	fldz   
  6c:	dd 05 10 08 00 00    	fldl   0x810
  72:	dc c1                	fadd   %st,%st(1)
  74:	d9 05 18 08 00 00    	flds   0x818
...
printf(int fd, const char *fmt, ...)
{
 ...
 614:	eb 1a                	jmp    630 <printf+0x1a0>
          s = "(null)";
 616:	bb 1c 08 00 00       	mov    $0x81c,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 665:	a1 cc 0a 00 00       	mov    0xacc,%eax
{
 ...
 686:	73 10                	jae    698 <free+0x38>
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 6b7:	5e                   	pop    %esi
 6b8:	5f                   	pop    %edi
 6b9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 700:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 749:	8b 3d cc 0a 00 00    	mov    0xacc,%edi
 ...
 772:	e8 e9 fe ff ff       	call   660 <free>
  return freep;
 777:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 7a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7a7:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 ...
 7be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 7c7:	0a 00 00 
    base.s.size = 0;
 7ca:	bf d0 0a 00 00       	mov    $0xad0,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 7d6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7db:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 7e2:	00 00 00 
    if(p->s.size >= nunits){
