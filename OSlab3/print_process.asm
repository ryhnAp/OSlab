...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb be 07 00 00       	mov    $0x7be,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 754:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 757:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 ...
 76e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 792:	00 00 00 
    if(p->s.size >= nunits){
