...
_check_syscall_running_steps:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  19:	7e 18                	jle    33 <main+0x33>
    {
        exit();
    }

    pid_check = getpid();
  1b:	e8 03 03 00 00       	call   323 <getpid>
    
    printf(1, "see pid:%d\n", pid_check);
  20:	52                   	push   %edx
  21:	50                   	push   %eax
  22:	68 a8 07 00 00       	push   $0x7a8
  27:	6a 01                	push   $0x1
  29:	e8 12 04 00 00       	call   440 <printf>
...
00000343 <find_next_prime_number>:
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb b4 07 00 00       	mov    $0x7b4,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 615:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 636:	73 10                	jae    648 <free+0x38>
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	a3 64 0a 00 00       	mov    %eax,0xa64
}
 667:	5e                   	pop    %esi
 668:	5f                   	pop    %edi
 669:	5d                   	pop    %ebp
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 64 0a 00 00       	mov    %eax,0xa64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6b0:	8b 3d 64 0a 00 00    	mov    0xa64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6f9:	8b 3d 64 0a 00 00    	mov    0xa64,%edi
 ...
 722:	e8 e9 fe ff ff       	call   610 <free>
  return freep;
 727:	a1 64 0a 00 00       	mov    0xa64,%eax
 ...
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf 68 0a 00 00       	mov    $0xa68,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 78b:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 792:	00 00 00 
    if(p->s.size >= nunits){
