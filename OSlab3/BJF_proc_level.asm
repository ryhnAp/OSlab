...
printf(int fd, const char *fmt, ...)
{
 ...
 604:	eb 1a                	jmp    620 <printf+0x1a0>
          s = "(null)";
 606:	bb fd 07 00 00       	mov    $0x7fd,%ebx
        while(*s != 0){
 ...
 676:	73 10                	jae    688 <free+0x38>
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 6a9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6f0:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 739:	8b 3d b8 0a 00 00    	mov    0xab8,%edi
 ...
 794:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 797:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 ...
 7ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 b8 0a 00 00 bc 	movl   $0xabc,0xab8
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	bf bc 0a 00 00       	mov    $0xabc,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 7c6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7cb:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 7d2:	00 00 00 
    if(p->s.size >= nunits){
