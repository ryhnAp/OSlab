...
main(void)
{
  ...
  eb:	68 16 09 00 00       	push   $0x916
  f0:	e8 d6 02 00 00       	call   3cb <exec>
      printf(1, "init: exec sh failed\n");
  f5:	5a                   	pop    %edx
  f6:	59                   	pop    %ecx
  f7:	68 19 09 00 00       	push   $0x919
  fc:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b4:	eb 1a                	jmp    6d0 <printf+0x1a0>
          s = "(null)";
 6b6:	bb 38 09 00 00       	mov    $0x938,%ebx
        while(*s != 0){
