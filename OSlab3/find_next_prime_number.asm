...
_find_next_prime_number:     file format elf32-i386
  ...
  13:	89 fb                	mov    %edi,%ebx
{
  ...
  1f:	e8 1c 02 00 00       	call   240 <atoi>
  ...
  29:	e8 25 03 00 00       	call   353 <find_next_prime_number>
  2e:	83 c4 0c             	add    $0xc,%esp
  31:	50                   	push   %eax
  32:	68 b8 07 00 00       	push   $0x7b8
  37:	6a 01                	push   $0x1
...
00000353 <find_next_prime_number>:
 ...
 3ac:	89 d1                	mov    %edx,%ecx
{
 ...
 3d9:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	eb 1a                	jmp    5f0 <printf+0x1a0>
          s = "(null)";
 5d6:	bb d1 07 00 00       	mov    $0x7d1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 625:	a1 88 0a 00 00       	mov    0xa88,%eax
{
 ...
 646:	73 10                	jae    658 <free+0x38>
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 677:	5e                   	pop    %esi
 678:	5f                   	pop    %edi
 679:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6bd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6c0:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 709:	8b 3d 88 0a 00 00    	mov    0xa88,%edi
 ...
 732:	e8 e9 fe ff ff       	call   620 <free>
  return freep;
 737:	a1 88 0a 00 00       	mov    0xa88,%eax
 ...
 764:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 767:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 ...
 77e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 787:	0a 00 00 
    base.s.size = 0;
 78a:	bf 8c 0a 00 00       	mov    $0xa8c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 796:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 79b:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 7a2:	00 00 00 
    if(p->s.size >= nunits){
