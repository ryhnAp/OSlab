...
int main(int argc, char* argv[]) 
{
  ...
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 37 08 00 00       	push   $0x837
  37:	6a 01                	push   $0x1
  39:	e8 72 04 00 00       	call   4b0 <printf>
    	printf(1, "Child2 and Main Process needs to wait for child one fork and feedback done.\n");
  3e:	5a                   	pop    %edx
  3f:	59                   	pop    %ecx
  40:	68 dc 08 00 00       	push   $0x8dc
  45:	6a 01                	push   $0x1
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 30 09 00 00 	movzbl 0x930(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 29 09 00 00       	mov    $0x929,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 e4 0b 00 00       	mov    0xbe4,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
 ...
 6f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6fa:	a3 e4 0b 00 00       	mov    %eax,0xbe4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d e4 0b 00 00    	mov    0xbe4,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 e4 0b 00 00       	mov    0xbe4,%eax
 ...
 7c4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7c7:	a3 e4 0b 00 00       	mov    %eax,0xbe4
}
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 e4 0b 00 00 e8 	movl   $0xbe8,0xbe4
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf e8 0b 00 00       	mov    $0xbe8,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 e8 0b 00 00 e8 	movl   $0xbe8,0xbe8
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7fb:	c7 05 ec 0b 00 00 00 	movl   $0x0,0xbec
 802:	00 00 00 
    if(p->s.size >= nunits){
