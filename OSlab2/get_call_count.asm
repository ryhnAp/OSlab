...
int main(int argc, char* argv[]) 
{
  ...
  b0:	50                   	push   %eax
  b1:	53                   	push   %ebx
  b2:	68 b8 08 00 00       	push   $0x8b8
  b7:	6a 01                	push   $0x1
  b9:	e8 72 04 00 00       	call   530 <printf>
        kill(child1);
 ...
 11b:	68 74 09 00 00       	push   $0x974
 120:	6a 01                	push   $0x1
 122:	e8 09 04 00 00       	call   530 <printf>
	    printf(1, "Main Process child ID : 1:%d, 2:%d\n", child1, child2);
 127:	57                   	push   %edi
 128:	53                   	push   %ebx
 129:	68 20 09 00 00       	push   $0x920
 12e:	6a 01                	push   $0x1
 130:	e8 fb 03 00 00       	call   530 <printf>

        printf(1, "Main Process fork status:%d , write status:%d \n", fork_sol, write_sol);
 135:	83 c4 20             	add    $0x20,%esp
 138:	56                   	push   %esi
 139:	ff 75 e4             	pushl  -0x1c(%ebp)
 13c:	68 44 09 00 00       	push   $0x944
 141:	6a 01                	push   $0x1
 143:	e8 e8 03 00 00       	call   530 <printf>
 ...
 48c:	89 d1                	mov    %edx,%ecx
{
 ...
 4b9:	0f b6 92 94 09 00 00 	movzbl 0x994(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 6b4:	eb 1a                	jmp    6d0 <printf+0x1a0>
          s = "(null)";
 6b6:	bb 8a 09 00 00       	mov    $0x98a,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 705:	a1 48 0c 00 00       	mov    0xc48,%eax
{
 ...
 726:	73 10                	jae    738 <free+0x38>
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 757:	5e                   	pop    %esi
 758:	5f                   	pop    %edi
 759:	5d                   	pop    %ebp
 ...
 777:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 77a:	a3 48 0c 00 00       	mov    %eax,0xc48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 79d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7a0:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e9:	8b 3d 48 0c 00 00    	mov    0xc48,%edi
 ...
 812:	e8 e9 fe ff ff       	call   700 <free>
  return freep;
 817:	a1 48 0c 00 00       	mov    0xc48,%eax
 ...
 844:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 847:	a3 48 0c 00 00       	mov    %eax,0xc48
}
 ...
 85e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 48 0c 00 00 4c 	movl   $0xc4c,0xc48
 867:	0c 00 00 
    base.s.size = 0;
 86a:	bf 4c 0c 00 00       	mov    $0xc4c,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 4c 0c 00 00 4c 	movl   $0xc4c,0xc4c
 876:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 87b:	c7 05 50 0c 00 00 00 	movl   $0x0,0xc50
 882:	00 00 00 
    if(p->s.size >= nunits){
