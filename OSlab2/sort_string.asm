...
000000d0 <sorting>:
{
  ...
  e5:	ff 35 4c 0c 00 00    	pushl  0xc4c
 ...
 183:	68 f8 08 00 00       	push   $0x8f8
 188:	6a 01                	push   $0x1
 18a:	e8 01 04 00 00       	call   590 <printf>
 18f:	83 c4 10             	add    $0x10,%esp
 192:	e9 66 ff ff ff       	jmp    fd <sorting+0x2d>
        printf(1, "Unable to write in file.\n");
 197:	50                   	push   %eax
 198:	50                   	push   %eax
 199:	68 12 09 00 00       	push   $0x912
 19e:	6a 01                	push   $0x1
 1a0:	e8 eb 03 00 00       	call   590 <printf>
        exit();
 ...
 4ec:	89 d1                	mov    %edx,%ecx
{
 ...
 519:	0f b6 92 48 09 00 00 	movzbl 0x948(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 714:	eb 1a                	jmp    730 <printf+0x1a0>
          s = "(null)";
 716:	bb 40 09 00 00       	mov    $0x940,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 765:	a1 50 0c 00 00       	mov    0xc50,%eax
{
...
malloc(uint nbytes)
{
 ...
 7fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 800:	8b 3d 50 0c 00 00    	mov    0xc50,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 872:	e8 e9 fe ff ff       	call   760 <free>
  return freep;
 877:	a1 50 0c 00 00       	mov    0xc50,%eax
 ...
 8a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 8a7:	a3 50 0c 00 00       	mov    %eax,0xc50
}
