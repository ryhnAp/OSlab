...
int main(int argc, char *argv[])
{
  ...
  20:	52                   	push   %edx
  21:	50                   	push   %eax
  22:	68 88 07 00 00       	push   $0x788
  27:	6a 01                	push   $0x1
  29:	e8 f2 03 00 00       	call   420 <printf>
 ...
 37c:	89 d1                	mov    %edx,%ecx
{
 ...
 3a9:	0f b6 92 9c 07 00 00 	movzbl 0x79c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb 94 07 00 00       	mov    $0x794,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f5:	a1 44 0a 00 00       	mov    0xa44,%eax
{
 ...
 616:	73 10                	jae    628 <free+0x38>
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 647:	5e                   	pop    %esi
 648:	5f                   	pop    %edi
 649:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 68d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 690:	8b 3d 44 0a 00 00    	mov    0xa44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6d9:	8b 3d 44 0a 00 00    	mov    0xa44,%edi
 ...
 702:	e8 e9 fe ff ff       	call   5f0 <free>
  return freep;
 707:	a1 44 0a 00 00       	mov    0xa44,%eax
 ...
 734:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 737:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf 48 0a 00 00       	mov    $0xa48,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 76b:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 772:	00 00 00 
    if(p->s.size >= nunits){
